...
public class Item {
     ...
     * representation of a numerical ID. If both
     ...
     * in the world when this Item is
    ...
    public static void registerItems() {
        ...
        registerItemBlock(Blocks.field_192443_dR,
                (new ItemCloth(Blocks.field_192443_dR)).setUnlocalizedName("concrete"));
        registerItemBlock(Blocks.field_192444_dS,
                (new ItemCloth(Blocks.field_192444_dS)).setUnlocalizedName("concrete_powder"));
