...
public class Item {
    ...
    public String func_40397_d(ItemStack itemstack) {
        String s = (new StringBuilder()).append("")
                .append(StringTranslate.getInstance().translateNamedKey(func_40400_h(itemstack))).toString().trim();
        return s;
    }
    ...
    static {
        ...
        seeds = (new ItemSeeds(39, Block.crops.blockID, Block.tilledField.blockID)).setIconCoord(9, 0)
                .setItemName("seeds");
        helmetLeather = (new ItemArmor(42, EnumArmorMaterial.CLOTH, 0, 0)).setIconCoord(0, 0)
                .setItemName("helmetCloth");
        plateLeather = (new ItemArmor(43, EnumArmorMaterial.CLOTH, 0, 1)).setIconCoord(0, 1)
                .setItemName("chestplateCloth");
        legsLeather = (new ItemArmor(44, EnumArmorMaterial.CLOTH, 0, 2)).setIconCoord(0, 2)
        ...
        plateChain = (new ItemArmor(47, EnumArmorMaterial.CHAIN, 1, 1)).setIconCoord(1, 1)
        ...
        helmetDiamond = (new ItemArmor(54, EnumArmorMaterial.DIAMOND, 3, 0)).setIconCoord(3, 0)
                .setItemName("helmetDiamond");
        plateDiamond = (new ItemArmor(55, EnumArmorMaterial.DIAMOND, 3, 1)).setIconCoord(3, 1)
                .setItemName("chestplateDiamond");
        legsDiamond = (new ItemArmor(56, EnumArmorMaterial.DIAMOND, 3, 2)).setIconCoord(3, 2)
                .setItemName("leggingsDiamond");
        bootsDiamond = (new ItemArmor(57, EnumArmorMaterial.DIAMOND, 3, 3)).setIconCoord(3, 3)
        ...
        appleGold = (new ItemAppleGold(66, 10, 1.2F, false)).func_35424_o()
                .setPotionEffect(Potion.potionRegeneration.id, 30, 0, 1.0F).setIconCoord(11, 0)
                .setItemName("appleGold");
        ...
        bucketWater = (new ItemBucket(70, Block.waterMoving.blockID)).setIconCoord(11, 4).setItemName("bucketWater")
                .setContainerItem(bucketEmpty);
        bucketLava = (new ItemBucket(71, Block.lavaMoving.blockID)).setIconCoord(12, 4).setItemName("bucketLava")
                .setContainerItem(bucketEmpty);
        ...
        redstone = (new ItemRedstone(75)).setIconCoord(8, 3).setItemName("redstone")
                .func_40407_b(PotionHelper.field_40375_i);
        ...
        lightStoneDust = (new Item(92)).setIconCoord(9, 4).setItemName("yellowDust")
                .func_40407_b(PotionHelper.field_40372_j);
        ...
        pumpkinSeeds = (new ItemSeeds(105, Block.pumpkinStem.blockID, Block.tilledField.blockID)).setIconCoord(13, 3)
                .setItemName("seeds_pumpkin");
        melonSeeds = (new ItemSeeds(106, Block.melonStem.blockID, Block.tilledField.blockID)).setIconCoord(14, 3)
                .setItemName("seeds_melon");
        chickenRaw = (new ItemFood(109, 2, 0.3F, true)).setPotionEffect(Potion.potionHunger.id, 30, 0, 0.3F)
                .setIconCoord(9, 7).setItemName("chickenRaw");
        rottenFlesh = (new ItemFood(111, 4, 0.1F, true)).setPotionEffect(Potion.potionHunger.id, 30, 0, 0.8F)
                .setIconCoord(11, 5).setItemName("rottenFlesh");
        ghastTear = (new Item(114)).setIconCoord(11, 7).setItemName("ghastTear")
                .func_40407_b(PotionHelper.field_40366_c);
        netherStalkSeeds = (new ItemSeeds(116, Block.netherStalk.blockID, Block.slowSand.blockID)).setIconCoord(13, 7)
                .setItemName("netherStalkSeeds").func_40407_b("+4");
        spiderEye = (new ItemFood(119, 2, 0.8F, false)).setPotionEffect(Potion.potionPoison.id, 5, 0, 1.0F)
                .setIconCoord(11, 8).setItemName("spiderEye").func_40407_b(PotionHelper.field_40363_d);
        fermentedSpiderEye = (new Item(120)).setIconCoord(10, 8).setItemName("fermentedSpiderEye")
                .func_40407_b(PotionHelper.field_40364_e);
        blazePowder = (new Item(121)).setIconCoord(13, 9).setItemName("blazePowder")
                .func_40407_b(PotionHelper.field_40362_g);
        magmaCream = (new Item(122)).setIconCoord(13, 10).setItemName("magmaCream")
                .func_40407_b(PotionHelper.field_40374_h);
        ...
        speckledMelon = (new Item(126)).setIconCoord(9, 8).setItemName("speckledMelon")
                .func_40407_b(PotionHelper.field_40361_f);
        StatList.initStats();
    }
}
