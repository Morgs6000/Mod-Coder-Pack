...
public class lt
{
    ...
    public lt()
    {
        ...
        for(int i = 0; i < 256; i++)
        {
            if(ly.field_345_n[i] != null)
            {
                field_1182_g[i * 3 + 0] = ly.field_345_n[i].func_218_a(1);
                field_1182_g[i * 3 + 1] = ly.field_345_n[i].func_218_a(2);
                field_1182_g[i * 3 + 2] = ly.field_345_n[i].func_218_a(3);
            }
        }

    }

    public void func_799_a(jj jj1)
    {
        cn cn1 = jj1.field_1347_b;
        if(cn1 == null)
        {
            jj1.field_1351_f = true;
            jj1.field_1352_e = true;
            return;
        }
        int i = jj1.field_1354_c * 16;
        int j = jj1.field_1353_d * 16;
        int k = i + 16;
        int l = j + 16;
        ga ga1 = cn1.func_704_b(jj1.field_1354_c, jj1.field_1353_d);
        if(ga1.field_1524_q)
        {
            jj1.field_1351_f = true;
            jj1.field_1352_e = true;
        ...
        for(int i1 = l - 1; i1 >= j; i1--)
        {
            for(int j1 = k - 1; j1 >= i; j1--)
            {
                ...
                for(int j2 = 0; j2 < 128; j2++)
                {
                    ...
                    ly ly1 = ly.field_345_n[cn1.func_600_a(j1, j2, i1)];
                    if(ly1 == null)
                    {
                        flag = false;
                        continue;
                    }
                    if(ly1.field_356_bn == gb.field_1332_f)
                    {
                        int l2 = cn1.func_600_a(j1, j2 + 1, i1);
                        if(l2 != 0 && ly.field_345_n[l2].field_356_bn == gb.field_1332_f)
                        {
                            continue;
                        }
                        float f1 = ((float)j2 / 127F) * 0.6F + 0.4F;
                        float f2 = cn1.func_598_c(j1, j2 + 1, i1) * f1;
                        if(k2 < 0 || k2 >= 160)
                        {
                            continue;
                        }
                    ...
                    {
                        int i3 = i2 + k2 * 32;
                        int k3 = field_1182_g[ly1.field_376_bc * 3 + 0];
                        float f3 = (cn1.func_598_c(j1, j2 + 1, i1) * 0.8F + 0.2F) * f;
                        int j4 = k3;
                        if(i2 >= 0)
                        {
                            float f5 = f3;
                    ...
                    int j3 = i2 + (k2 + 1) * 32;
                    int l3 = field_1182_g[ly1.field_376_bc * 3 + 1];
                    float f4 = cn1.func_598_c(j1 - 1, j2, i1) * 0.8F + 0.2F;
                    int k4 = field_1182_g[ly1.field_376_bc * 3 + 2];
                    float f7 = cn1.func_598_c(j1, j2, i1 + 1) * 0.8F + 0.2F;
                    if(i2 >= 0)
                    {
                        float f8 = f4 * f * 0.6F;
        ...
        func_800_a();
        if(jj1.field_1348_a == null)
        {
            jj1.field_1348_a = new BufferedImage(32, 160, 2);
        }
        jj1.field_1348_a.setRGB(0, 0, 32, 160, field_1180_b, 0, 32);
        jj1.field_1352_e = true;
    }
