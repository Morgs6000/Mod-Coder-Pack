...
public class mo extends fk
{
    ...
    public mo(int i, int j, int k, int l, String s, float f)
    {
    ...
    protected void func_560_b(Minecraft minecraft, int i, int j)
    {
        ...
        if(field_943_j)
        {
            ...
            minecraft.field_160_y.func_1048_a(field_942_l, field_944_i);
            field_939_e = minecraft.field_160_y.func_1047_d(field_942_l);
        }
