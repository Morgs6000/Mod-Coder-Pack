    ...
    implements aw
{
    ...
    public nw(cn cn1, long l)
    {
        ...
        field_912_k = new lp(field_913_j, 16);
        field_911_l = new lp(field_913_j, 16);
        field_910_m = new lp(field_913_j, 8);
        field_909_n = new lp(field_913_j, 4);
        field_908_o = new lp(field_913_j, 4);
        field_922_a = new lp(field_913_j, 10);
        field_921_b = new lp(field_913_j, 16);
        field_920_c = new lp(field_913_j, 8);
    }
                    ...
                    for(int l1 = 0; l1 < 8; l1++)
                    {
                        ...
                        for(int i2 = 0; i2 < 4; i2++)
                        {
                            ...
                            for(int k2 = 0; k2 < 4; k2++)
                            {
                                ...
                                if(k1 * 8 + l1 < byte1)
                                {
                                    if(field_907_p.field_1047_d && k1 * 8 + l1 >= byte1 - 1)
                                    {
                                        l2 = ly.field_427_aU.field_376_bc;
                                    } else
                                    {
                                        l2 = ly.field_399_C.field_376_bc;
                                    }
                                }
                                if(d15 > 0.0D)
                                {
                                    l2 = ly.field_338_u.field_376_bc;
                                }
                                abyte0[j2] = (byte)l2;
                                j2 += c;
                                d15 += d16;
    ...
    public void func_545_b(int i, int j, byte abyte0[])
    {
        ...
        for(int k = 0; k < 16; k++)
        {
            for(int l = 0; l < 16; l++)
            {
                ...
                int j1 = -1;
                byte byte1 = (byte)ly.field_337_v.field_376_bc;
                byte byte2 = (byte)ly.field_336_w.field_376_bc;
                for(int k1 = 127; k1 >= 0; k1--)
                {
                    int l1 = (k * 16 + l) * 128 + k1;
                    if(k1 <= (0 + field_913_j.nextInt(6)) - 1)
                    {
                        abyte0[l1] = (byte)ly.field_403_A.field_376_bc;
                        continue;
                    }
                    ...
                    if(byte3 != ly.field_338_u.field_376_bc)
                    {
                        continue;
                    }
                    if(j1 == -1)
                    {
                        ...
                        {
                            byte1 = 0;
                            byte2 = (byte)ly.field_338_u.field_376_bc;
                        } else
                        if(k1 >= byte0 - 4 && k1 <= byte0 + 1)
                        {
                            byte1 = (byte)ly.field_337_v.field_376_bc;
                            byte2 = (byte)ly.field_336_w.field_376_bc;
                            if(flag1)
                            {
                                byte1 = 0;
                            }
                            if(flag1)
                            {
                                byte2 = (byte)ly.field_392_G.field_376_bc;
                            }
                            if(flag)
                            {
                                byte1 = (byte)ly.field_393_F.field_376_bc;
                            }
                            if(flag)
                            {
                                byte2 = (byte)ly.field_393_F.field_376_bc;
                            }
                        }
                        if(k1 < byte0 && byte1 == 0)
                        {
                            byte1 = (byte)ly.field_399_C.field_376_bc;
                        }
                        j1 = i1;
                        if(k1 >= byte0 - 1)
                        {
    ...
    public ga func_533_b(int i, int j)
    {
        ...
        ga ga1 = new ga(field_907_p, abyte0, i, j);
    ...
    public void func_534_a(aw aw1, int i, int j)
    {
        ...
        int k = i * 16;
        int l = j * 16;
        field_913_j.setSeed(field_907_p.field_1030_u);
        long l1 = (field_913_j.nextLong() / 2L) * 2L + 1L;
        long l2 = (field_913_j.nextLong() / 2L) * 2L + 1L;
        field_913_j.setSeed((long)i * l1 + (long)j * l2 ^ field_907_p.field_1030_u);
        double d = 0.25D;
        for(int i1 = 0; i1 < 8; i1++)
        {
            ...
            (new cg()).func_516_a(field_907_p, field_913_j, i4, j6, i11);
        }
        ...
        for(int j1 = 0; j1 < 10; j1++)
        {
            ...
            (new gv(32)).func_516_a(field_907_p, field_913_j, j4, k6, j11);
        }
        ...
        for(int k1 = 0; k1 < 20; k1++)
        {
            ...
            (new cu(ly.field_336_w.field_376_bc, 32)).func_516_a(field_907_p, field_913_j, k4, l6, k11);
        }
        ...
        for(int i2 = 0; i2 < 10; i2++)
        {
            ...
            (new cu(ly.field_392_G.field_376_bc, 32)).func_516_a(field_907_p, field_913_j, l4, i7, l11);
        }
        ...
        for(int j2 = 0; j2 < 20; j2++)
        {
            ...
            (new cu(ly.field_386_J.field_376_bc, 16)).func_516_a(field_907_p, field_913_j, i5, j7, i12);
        }
        ...
        for(int k2 = 0; k2 < 20; k2++)
        {
            ...
            (new cu(ly.field_388_I.field_376_bc, 8)).func_516_a(field_907_p, field_913_j, j5, k7, j12);
        }
        ...
        for(int i3 = 0; i3 < 2; i3++)
        {
            ...
            (new cu(ly.field_390_H.field_376_bc, 8)).func_516_a(field_907_p, field_913_j, k5, l7, k12);
        }
        ...
        for(int j3 = 0; j3 < 8; j3++)
        {
            ...
            (new cu(ly.field_433_aO.field_376_bc, 7)).func_516_a(field_907_p, field_913_j, l5, i8, l12);
        }
        ...
        for(int k3 = 0; k3 < 1; k3++)
        {
            ...
            (new cu(ly.field_391_ax.field_376_bc, 7)).func_516_a(field_907_p, field_913_j, i6, j8, i13);
        }
        ...
        for(int k8 = 0; k8 < l3; k8++)
        {
            ...
            ((ik) (obj)).func_517_a(1.0D, 1.0D, 1.0D);
            ((ik) (obj)).func_516_a(field_907_p, field_913_j, j13, field_907_p.func_666_c(j13, l15), l15);
        }
        ...
        for(int l8 = 0; l8 < 2; l8++)
        {
            ...
            (new ae(ly.field_417_ae.field_376_bc)).func_516_a(field_907_p, field_913_j, k13, i16, j18);
        }
        ...
        if(field_913_j.nextInt(2) == 0)
        {
            ...
            (new ae(ly.field_416_af.field_376_bc)).func_516_a(field_907_p, field_913_j, i9, l13, j16);
        }
        if(field_913_j.nextInt(4) == 0)
        {
            ...
            (new ae(ly.field_415_ag.field_376_bc)).func_516_a(field_907_p, field_913_j, j9, i14, k16);
        }
        if(field_913_j.nextInt(8) == 0)
        {
            ...
            (new ae(ly.field_414_ah.field_376_bc)).func_516_a(field_907_p, field_913_j, k9, j14, l16);
        }
        for(int l9 = 0; l9 < 10; l9++)
        {
            ...
            (new es()).func_516_a(field_907_p, field_913_j, k14, i17, k18);
        }
        ...
        for(int i10 = 0; i10 < 1; i10++)
        {
            ...
            (new da()).func_516_a(field_907_p, field_913_j, l14, j17, l18);
        }
        ...
        for(int j10 = 0; j10 < 50; j10++)
        {
            ...
            (new nn(ly.field_401_B.field_376_bc)).func_516_a(field_907_p, field_913_j, i15, k17, i19);
        }
        ...
        for(int k10 = 0; k10 < 20; k10++)
        {
            ...
            (new nn(ly.field_397_D.field_376_bc)).func_516_a(field_907_p, field_913_j, j15, l17, j19);
        }
        ...
        for(int l10 = k + 8 + 0; l10 < k + 8 + 16; l10++)
        {
            for(int k15 = l + 8 + 0; k15 < l + 8 + 16; k15++)
            {
                ...
                if(field_907_p.field_1047_d && i18 > 0 && i18 < 128 && field_907_p.func_600_a(l10, i18, k15) == 0 && field_907_p.func_599_f(l10, i18 - 1, k15).func_880_c() && field_907_p.func_599_f(l10, i18 - 1, k15) != gb.field_1320_r)
                {
                    field_907_p.func_690_d(l10, i18, k15, ly.field_428_aT.field_376_bc);
                }
            }

        }

        dh.field_466_a = false;
    }
    ...
    private lp field_912_k;
    private lp field_911_l;
    private lp field_910_m;
    private lp field_909_n;
    private lp field_908_o;
    public lp field_922_a;
    public lp field_921_b;
    public lp field_920_c;
    private cn field_907_p;
    private double field_906_q[];
    private double field_905_r[];
    private double field_904_s[];
    private double field_903_t[];
    private cy field_902_u;
    double field_919_d[];
    double field_918_e[];
    double field_917_f[];
    double field_916_g[];
