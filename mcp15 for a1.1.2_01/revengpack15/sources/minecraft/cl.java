...
public class cl extends fo
{
    ...
    public cl()
    {
        field_1287_a = new ip[5];
        field_1287_a[0] = new ip(0, 8);
        field_1287_a[1] = new ip(0, 0);
        field_1287_a[2] = new ip(0, 0);
        field_1287_a[3] = new ip(0, 0);
        field_1287_a[4] = new ip(0, 0);
        byte byte0 = 24;
        byte byte1 = 6;
        byte byte2 = 20;
        byte byte3 = 4;
