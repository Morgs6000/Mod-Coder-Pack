...
public class jy extends fo
{
    ...
    public void func_863_a(float f, float f1, float f2, float f3, float f4, float f5)
    {
        ...
        float f9 = -(eo.func_1114_b(f * 0.6662F * 2.0F + 0.0F) * 0.4F) * f1;
        float f10 = -(eo.func_1114_b(f * 0.6662F * 2.0F + 3.141593F) * 0.4F) * f1;
        float f11 = -(eo.func_1114_b(f * 0.6662F * 2.0F + 1.570796F) * 0.4F) * f1;
        float f12 = -(eo.func_1114_b(f * 0.6662F * 2.0F + 4.712389F) * 0.4F) * f1;
        float f13 = Math.abs(eo.func_1106_a(f * 0.6662F + 0.0F) * 0.4F) * f1;
        float f14 = Math.abs(eo.func_1106_a(f * 0.6662F + 3.141593F) * 0.4F) * f1;
        float f15 = Math.abs(eo.func_1106_a(f * 0.6662F + 1.570796F) * 0.4F) * f1;
        float f16 = Math.abs(eo.func_1106_a(f * 0.6662F + 4.712389F) * 0.4F) * f1;
    ...
    public ip field_1255_a;
    public ip field_1254_b;
    public ip field_1253_c;
    public ip field_1252_d;
    public ip field_1251_e;
    public ip field_1250_f;
    public ip field_1249_g;
    public ip field_1248_h;
    public ip field_1247_i;
    public ip field_1246_j;
    public ip field_1245_m;
}
