...
public class MinecraftApplet extends Applet
{
    ...
    public void init()
    {
        field_132_a = new h(this);
        boolean flag = false;
        if(getParameter("fullscreen") != null)
        {
            flag = getParameter("fullscreen").equalsIgnoreCase("true");
        }
        field_131_b = new g(this, this, field_132_a, this, getWidth(), getHeight(), flag);
        ...
        {
            field_131_b.field_176_i = new dl(getParameter("username"), getParameter("sessionid"));
        ...
        {
            field_131_b.field_176_i = new dl("Player", "");
        }
