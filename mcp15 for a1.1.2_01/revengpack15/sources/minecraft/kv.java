...
public class kv extends fo
{
    ...
    public void func_863_a(float f, float f1, float f2, float f3, float f4, float f5)
    {
        ...
        field_1295_c.field_1407_d = eo.func_1114_b(f * 0.6662F) * 1.4F * f1;
        field_1294_d.field_1407_d = eo.func_1114_b(f * 0.6662F + 3.141593F) * 1.4F * f1;
        field_1293_e.field_1405_f = f2;
        field_1292_f.field_1405_f = -f2;
    }

    public ip field_1289_a;
    public ip field_1288_b;
    public ip field_1295_c;
    public ip field_1294_d;
    public ip field_1293_e;
    public ip field_1292_f;
    public ip field_1291_g;
    public ip field_1290_h;
}
