...
public class id extends ee
{
    ...
    {
        field_978_j = ke1;
        field_973_i.add(new mm(this, ke1, 0, 56, 17));
        field_973_i.add(new mm(this, ke1, 1, 56, 53));
        field_973_i.add(new mm(this, ke1, 2, 116, 35));
        for(int i = 0; i < 3; i++)
        {
            for(int k = 0; k < 9; k++)
            {
                field_973_i.add(new mm(this, eu, k + (i + 1) * 9, 8 + k * 18, 84 + i * 18));
            }
        ...
        for(int j = 0; j < 9; j++)
        {
            field_973_i.add(new mm(this, eu, j, 8 + j * 18, 142));
        }
    ...
    {
        int i = field_945_b.field_171_n.func_1070_a("/gui/furnace.png");
