...
public class ei extends ak
{
    ...
    public void func_155_a(ao ao1, double d, double d1, double d2, 
            float f, float f1)
    {
        GL11.glPushMatrix();
        ...
        int i = di.field_308_aB.func_196_a(null);
        ...
        ho1.func_983_a(0.0F - f7, 0.0F - f8, 0.0D, f2, f5);
        ho1.func_983_a(f6 - f7, 0.0F - f8, 0.0D, f3, f5);
        ho1.func_983_a(f6 - f7, 1.0F - f8, 0.0D, f3, f4);
        ho1.func_983_a(0.0F - f7, 1.0F - f8, 0.0D, f2, f4);
        ho1.func_982_a();
