...
public class bn
{
    ...
    public bn(cn cn, List list, int i, int j, int k, int l, int i1)
    {
        field_1744_C = -1;
        field_1749_o = false;
        ...
        field_1740_t = eo.func_1113_c(field_1758_f * field_1758_f + field_1757_g * field_1757_g + field_1756_h * field_1756_h) / 2.0F;
        field_1744_C = i1;
        field_1761_c = -999;
        func_1197_a(i, j, k);
        field_1738_u = false;
    ...
    public void func_1197_a(int i, int j, int k)
    {
        ...
        } else
        {
            ...
            float f = 2.0F;
            field_1736_v = cf.func_1168_a((float)i - f, (float)j - f, (float)k - f, (float)(i + field_1758_f) + f, (float)(j + field_1757_g) + f, (float)(k + field_1756_h) + f);
            GL11.glNewList(field_1744_C + 2, 4864);
            ab.func_142_a(cf.func_1161_b((float)field_1752_l - f, (float)field_1751_m - f, (float)field_1750_n - f, (float)(field_1752_l + field_1758_f) + f, (float)(field_1751_m + field_1757_g) + f, (float)(field_1750_n + field_1756_h) + f));
            GL11.glEndList();
            func_1194_f();
            return;
        }
    ...
    public void func_1198_a()
    {
        ...
        ga.field_1540_a = false;
        HashSet hashset = new HashSet();
        hashset.addAll(field_1745_B);
        field_1745_B.clear();
        int l1 = 1;
        ci ci1 = new ci(field_1763_a, i - l1, j - l1, k - l1, l + l1, i1 + l1, j1 + l1);
        bc bc1 = new bc(ci1);
        int i2 = 0;
        do
        {
            ...
            for(int j2 = j; j2 < i1; j2++)
            {
                for(int k2 = k; k2 < j1; k2++)
                {
                    ...
                    {
                        int i3 = ci1.func_600_a(l2, j2, k2);
                        if(i3 <= 0)
                        {
                            continue;
                        }
                        ...
                        if(i2 == 0 && ly.field_342_q[i3])
                        {
                            ic ic = ci1.func_603_b(l2, j2, k2);
                            if(fz.field_1554_a.func_1028_a(ic))
                            {
                                field_1745_B.add(ic);
                            }
                        }
                        ly ly1 = ly.field_345_n[i3];
                        int j3 = ly1.func_234_g();
                        if(j3 != i2)
                        {
                            flag = true;
                            continue;
                        ...
                        if(j3 == i2)
                        {
                            flag1 |= bc1.func_1234_a(ly1, l2, j2, k2);
                        }
                    }
        ...
        field_1747_A = ga.field_1540_a;
        field_1739_E = true;
    }

    public float func_1202_a(kh kh1)
    {
        float f = (float)(kh1.field_611_ak - (double)field_1746_q);
        float f1 = (float)(kh1.field_610_al - (double)field_1743_r);
        float f2 = (float)(kh1.field_609_am - (double)field_1741_s);
    ...
    public void func_1199_a(oe oe1)
    {
        field_1749_o = oe1.func_342_a(field_1736_v);
    }
    ...
    public cn field_1763_a;
    private int field_1744_C;
    private static ho field_1742_D;
