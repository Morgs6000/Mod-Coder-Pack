...
public class fk extends lm
{
    ...
    public void func_561_a(Minecraft minecraft, int i, int j)
    {
        ...
        if(!field_937_g)
        {
            func_548_a(kd, field_939_e, field_941_c + field_935_a / 2, field_940_d + (field_934_b - 8) / 2, 0xffa0a0a0);
        } else
        if(flag)
        {
            func_548_a(kd, field_939_e, field_941_c + field_935_a / 2, field_940_d + (field_934_b - 8) / 2, 0xffffa0);
        } else
        {
            func_548_a(kd, field_939_e, field_941_c + field_935_a / 2, field_940_d + (field_934_b - 8) / 2, 0xe0e0e0);
        }
    }
    ...
    {
        return field_937_g && i >= field_941_c && j >= field_940_d && i < field_941_c + field_935_a && j < field_940_d + field_934_b;
    }
