...
public class bf extends Thread
{
    ...
    private void func_1209_a(File file, String s)
    {
        ...
        for(int i = 0; i < afile.length; i++)
        {
            ...
            try
            {
                field_1767_b.func_131_a((new StringBuilder()).append(s).append(afile[i].getName()).toString(), afile[i]);
            }
            catch(Exception exception)
            {
    ...
    private void func_1211_a(URL url, String s, long l, int i)
    {
        try
        {
            ...
            field_1767_b.func_131_a(s, file);
        }
        catch(Exception exception)
        {
            exception.printStackTrace();
    ...
    private void func_1212_a(URL url, File file, long l) throws IOException
    {
