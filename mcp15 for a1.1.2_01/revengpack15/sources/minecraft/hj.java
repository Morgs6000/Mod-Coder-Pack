...
public class hj extends fo
{
    ...
    public hj()
    {
        field_1256_a = new ip[7];
        field_1256_a[0] = new ip(0, 10);
        field_1256_a[1] = new ip(0, 0);
        field_1256_a[2] = new ip(0, 0);
        field_1256_a[3] = new ip(0, 0);
        field_1256_a[4] = new ip(0, 0);
        field_1256_a[5] = new ip(44, 10);
        byte byte0 = 20;
        byte byte1 = 8;
        byte byte2 = 16;
        byte byte3 = 4;
