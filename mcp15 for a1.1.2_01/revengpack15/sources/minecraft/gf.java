...
public class gf extends di
{
    ...
    public boolean func_192_a(ev ev1, dm dm, cn cn1, int i, int j, int k, int l)
    {
        ...
        if(cn1.func_695_a(field_320_a, i, j, k, false))
        {
            ly ly1 = ly.field_345_n[field_320_a];
            if(cn1.func_690_d(i, j, k, field_320_a))
            {
                ly.field_345_n[field_320_a].func_258_d(cn1, i, j, k, l);
