...
public class j extends bt
{
    ...
    public j()
    {
        field_1693_f = df.func_1123_d(16);
        field_1692_g = df.func_1123_d(16);
        field_1691_h = df.func_1123_d(16);
    }

    public static bt func_1155_a()
    {
    ...
    {
        float f = eo.func_1113_c(af[i][0] * af[i][0] + af[i][1] * af[i][1] + af[i][2] * af[i][2]);
        af[i][0] /= f;
        af[i][1] /= f;
        af[i][2] /= f;
        af[i][3] /= f;
    ...
    private static j field_1694_e = new j();
