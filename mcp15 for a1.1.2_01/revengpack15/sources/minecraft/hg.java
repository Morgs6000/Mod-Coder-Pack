...
public class hg extends fo
{
    ...
    public void func_863_a(float f, float f1, float f2, float f3, float f4, float f5)
    {
        ...
        field_1264_f.field_1407_d = eo.func_1114_b(f * 0.6662F) * 1.4F * f1;
        field_1263_g.field_1407_d = eo.func_1114_b(f * 0.6662F + 3.141593F) * 1.4F * f1;
        field_1262_h.field_1407_d = eo.func_1114_b(f * 0.6662F + 3.141593F) * 1.4F * f1;
        field_1261_i.field_1407_d = eo.func_1114_b(f * 0.6662F) * 1.4F * f1;
    }

    public ip field_1266_d;
    public ip field_1265_e;
    public ip field_1264_f;
    public ip field_1263_g;
    public ip field_1262_h;
    public ip field_1261_i;
}
