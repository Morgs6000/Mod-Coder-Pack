...
public class em extends fo
{
    ...
    public void func_863_a(float f, float f1, float f2, float f3, float f4, float f5)
    {
        ...
        field_1275_d.field_1407_d = eo.func_1114_b(f * 0.6662F) * 1.4F * f1;
        field_1274_e.field_1407_d = eo.func_1114_b(f * 0.6662F + 3.141593F) * 1.4F * f1;
        field_1273_f.field_1407_d = eo.func_1114_b(f * 0.6662F + 3.141593F) * 1.4F * f1;
        field_1272_g.field_1407_d = eo.func_1114_b(f * 0.6662F) * 1.4F * f1;
    }

    public ip field_1271_a;
    public ip field_1270_b;
    public ip field_1276_c;
    public ip field_1275_d;
    public ip field_1274_e;
    public ip field_1273_f;
    public ip field_1272_g;
}
