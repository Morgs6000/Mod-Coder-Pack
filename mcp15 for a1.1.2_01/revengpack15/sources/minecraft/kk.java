...
public class kk extends cy
{
    ...
    protected void func_870_a(int i, int j, byte abyte0[], double d, double d1, 
            double d2)
    {
        func_869_a(i, j, abyte0, d, d1, d2, 1.0F + field_1305_b.nextFloat() * 6F, 0.0F, 0.0F, -1, -1, 0.5D);
    }

    protected void func_869_a(int i, int j, byte abyte0[], double d, double d1, 
            ...
            double d3)
    {
        ...
        for(; k < l; k++)
        {
            double d6 = 1.5D + (double)(eo.func_1106_a(((float)k * 3.141593F) / (float)l) * f * 1.0F);
            double d7 = d6 * d3;
            float f5 = eo.func_1114_b(f2);
            float f6 = eo.func_1106_a(f2);
            d += eo.func_1114_b(f1) * f5;
            d1 += f6;
            d2 += eo.func_1106_a(f1) * f5;
            if(flag1)
            {
                f2 *= 0.92F;
            } else
            ...
            if(!flag && k == j1 && f > 1.0F)
            {
                func_869_a(i, j, abyte0, d, d1, d2, random.nextFloat() * 0.5F + 0.5F, f1 - 1.570796F, f2 / 3F, k, l, 1.0D);
                func_869_a(i, j, abyte0, d, d1, d2, random.nextFloat() * 0.5F + 0.5F, f1 + 1.570796F, f2 / 3F, k, l, 1.0D);
                return;
            }
            ...
            for(int j2 = (int) d8; !flag2 && j2 < k1; j2++)
            {
                for(int l2 = (int) d10; !flag2 && l2 < i2; l2++)
                {
                    for(int i3 = l1 + 1; !flag2 && i3 >= d9 - 1; i3--)
                    {
                        ...
                        if(abyte0[j3] == ly.field_401_B.field_376_bc || abyte0[j3] == ly.field_399_C.field_376_bc)
                        {
                            flag2 = true;
                        }
                ...
                for(int k3 = (int) d10; k3 < i2; k3++)
                {
                    ...
                    for(int i4 = l1 - 1; i4 >= d9; i4--)
                    {
                        ...
                        if(d14 > -0.69999999999999996D && d12 * d12 + d14 * d14 + d13 * d13 < 1.0D)
                        {
                            ...
                            if(byte0 == ly.field_337_v.field_376_bc)
                            {
                                flag3 = true;
                            }
                            if(byte0 == ly.field_338_u.field_376_bc || byte0 == ly.field_336_w.field_376_bc || byte0 == ly.field_337_v.field_376_bc)
                            {
                                if(i4 < 10)
                                {
                                    abyte0[l3] = (byte)ly.field_397_D.field_376_bc;
                                } else
                                {
                                    abyte0[l3] = 0;
                                    if(flag3 && abyte0[l3 - 1] == ly.field_336_w.field_376_bc)
                                    {
                                        abyte0[l3 - 1] = (byte)ly.field_337_v.field_376_bc;
                                    }
                                }
                            }
                        }
    ...
    protected void func_868_a(cn cn, int i, int j, int k, int l, byte abyte0[])
    {
        ...
        for(int j1 = 0; j1 < i1; j1++)
        {
            ...
            for(int l1 = 0; l1 < k1; l1++)
            {
                ...
                func_869_a(k, l, abyte0, d, d1, d2, f2, f, f1, 0, 0, 1.0D);
            }
