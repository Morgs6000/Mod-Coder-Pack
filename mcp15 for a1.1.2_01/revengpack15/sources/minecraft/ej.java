...
public class ej extends ik
{
        ...
        for(; j1 <= i1; j1++)
        {
            ...
            for(int l1 = -i1; l1 <= i1;)
            {
                ...
                } else
                {
                    ...
                    {
                        field_880_c.func_634_a(ai1[0], ai1[1], ai1[2], l);
                        l1++;
                    }
                }
            }
    ...
    void func_522_a(int ai[], int ai1[], int i)
    {
        ...
        {
            ai3[j] = eo.b((double)(ai[j] + k) + 0.5D);
            ai3[byte1] = eo.b((double)ai[byte1] + (double)k * d + 0.5D);
            ai3[byte2] = eo.b((double)ai[byte2] + (double)k * d1 + 0.5D);
            field_880_c.func_634_a(ai3[0], ai3[1], ai3[2], i);
        }
