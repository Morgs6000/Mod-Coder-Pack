...
public class kd
{
    ...
    public kd(fr fr1, java.lang.String s, ey ey1)
    {
        ...
        try
        {
            bufferedimage = javax.imageio.ImageIO.read(((java.lang.Class) (ey)).getResourceAsStream(s));
        }
        catch(java.io.IOException ioexception)
        {
            throw new RuntimeException(((java.lang.Throwable) (ioexception)));
        }
        ...
        {
            org.lwjgl.opengl.GL11.glNewList(c + i1, 4864);
            ho1.b();
            int l1 = (i1 % 16) * 8;
            int k2 = (i1 / 16) * 8;
            float f = 7.99F;
            ...
            ho1.a();
            org.lwjgl.opengl.GL11.glTranslatef(b[i1], 0.0F, 0.0F);
        ...
        for(int j1 = 0; j1 < 32; j1++)
        {
            ...
            org.lwjgl.opengl.GL11.glNewList(c + 256 + j1, 4864);
            org.lwjgl.opengl.GL11.glColor3f((float)l2 / 255F, (float)j3 / 255F, (float)k3 / 255F);
            org.lwjgl.opengl.GL11.glEndList();
        }
    ...
    public void a(java.lang.String s, int i, int j, int k, boolean flag)
    {
        ...
        org.lwjgl.opengl.GL11.glBindTexture(3553, a);
        ...
        org.lwjgl.opengl.GL11.glTranslatef(i, j, 0.0F);
        for(int i1 = 0; i1 < s.length(); i1++)
        {
            for(; s.charAt(i1) == '\247' && s.length() > i1 + 1; i1 += 2)
            {
                ...
                {
                    d.flip();
                    org.lwjgl.opengl.GL11.glCallLists(d);
                    d.clear();
                }
            }
