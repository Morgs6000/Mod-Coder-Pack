...
public class gi extends bc
{
    ...
    void a()
    {
        ...
        if(f >= e)
            f = e - 1;
        int i1 = (int)(1.3819999999999999D + java.lang.Math.pow((k * (double)e) / 13D, 2D));
        if(i1 < 1)
            i1 = 1;
        ...
        while(i2 >= 0) 
        {
            ...
            } else
            {
                ...
                for(; j2 < i1; j2++)
                {
                    ...
                    int k2 = (int)(d2 * java.lang.Math.sin(d3) + (double)d[0] + d1);
                    int l2 = (int)(d2 * java.lang.Math.cos(d3) + (double)d[2] + d1);
                    int ai1[] = {
                        k2, j1, l2
                    };
                    int ai2[] = {
                    ...
                    double d4 = java.lang.Math.sqrt(java.lang.Math.pow(java.lang.Math.abs(d[0] - ai1[0]), 2D) + java.lang.Math.pow(java.lang.Math.abs(d[2] - ai1[2]), 2D));
                    double d5 = d4 * i;
    ...
    void a(int i1, int j1, int k1, float f1, byte byte0, int l1)
    {
        ...
        for(; j2 <= i2; j2++)
        {
            ...
            for(int l2 = -i2; l2 <= i2;)
            {
                double d1 = java.lang.Math.sqrt(java.lang.Math.pow((double)java.lang.Math.abs(j2) + 0.5D, 2D) + java.lang.Math.pow((double)java.lang.Math.abs(l2) + 0.5D, 2D));
                if(d1 > (double)f1)
                {
                    l2++;
                } else
    ...
    float a(int i1)
    {
        ...
        if(java.lang.Math.abs(f2) >= f1)
            f3 = 0.0F;
        else
            f3 = (float)java.lang.Math.sqrt(java.lang.Math.pow(java.lang.Math.abs(f1), 2D) - java.lang.Math.pow(java.lang.Math.abs(f2), 2D));
        f3 *= 0.5F;
        return f3;
    }
    ...
    void a(int ai[], int ai1[], int i1)
    {
        ...
        for(; byte0 < 3; byte0++)
        {
            ...
            if(java.lang.Math.abs(ai2[byte0]) > java.lang.Math.abs(ai2[j1]))
                j1 = ((int) (byte0));
        }
        ...
        {
            ai3[j1] = gj.b((double)(ai[j1] + k1) + 0.5D);
            ai3[byte1] = gj.b((double)ai[byte1] + (double)k1 * d1 + 0.5D);
            ai3[byte2] = gj.b((double)ai[byte2] + (double)k1 * d2 + 0.5D);
    ...
    int a(int ai[], int ai1[])
    {
        ...
        {
            ai2[byte0] = ai1[byte0] - ai[byte0];
            if(java.lang.Math.abs(ai2[byte0]) > java.lang.Math.abs(ai2[i1]))
                i1 = ((int) (byte0));
        }
    ...
    public boolean a(dy dy1, java.util.Random random, int i1, int j1, int k1)
    {
        c = dy1;
