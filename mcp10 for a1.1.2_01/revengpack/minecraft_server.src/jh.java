...
public class jh
{
    ...
    public void a(ev ev1)
    {
        ...
        } else
        {
            ...
            org.lwjgl.opengl.GL11.glTranslatef(-f5, -f6, 0.0F);
            float f7 = 1.5F;
            org.lwjgl.opengl.GL11.glScalef(f7, f7, f7);
            org.lwjgl.opengl.GL11.glRotatef(50F, 0.0F, 1.0F, 0.0F);
            org.lwjgl.opengl.GL11.glRotatef(335F, 0.0F, 0.0F, 1.0F);
            org.lwjgl.opengl.GL11.glTranslatef(-0.9375F, -0.0625F, 0.0F);
            float f8 = 0.0625F;
            ho1.b();
    ...
    public void b(float f)
    {
        ...
        if(a.g.a(gb.f))
        {
            ...
            org.lwjgl.opengl.GL11.glBindTexture(3553, l);
            c(f);
        }
    ...
    private void a(float f, int j)
    {
        ...
        float f1 = a.g.a(f);
        f1 = 0.1F;
        org.lwjgl.opengl.GL11.glColor4f(f1, f1, f1, 0.5F);
        org.lwjgl.opengl.GL11.glPushMatrix();
        float f2 = -1F;
        float f3 = 1.0F;
        float f4 = -1F;
    ...
    {
        ho ho1 = ho.a;
        org.lwjgl.opengl.GL11.glColor4f(1.0F, 1.0F, 1.0F, 0.9F);
        org.lwjgl.opengl.GL11.glEnable(3042);
        org.lwjgl.opengl.GL11.glBlendFunc(770, 771);
        float f1 = 1.0F;
        for(int j = 0; j < 2; j++)
        {
            ...
            float f9 = f8 + f1;
            float f10 = -0.5F;
            org.lwjgl.opengl.GL11.glTranslatef((float)(-(j * 2 - 1)) * 0.24F, -0.3F, 0.0F);
            org.lwjgl.opengl.GL11.glRotatef((float)(j * 2 - 1) * 10F, 0.0F, 1.0F, 0.0F);
            ho1.b();
