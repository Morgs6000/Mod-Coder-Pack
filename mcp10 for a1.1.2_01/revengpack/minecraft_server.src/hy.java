    ...
    implements bj
{
    ...
    public void b(int i1, int j1, byte abyte0[])
    {
        ...
        for(int k1 = 0; k1 < 16; k1++)
        {
            for(int l1 = 0; l1 < 16; l1++)
            {
                ...
                int j2 = -1;
                byte byte1 = (byte)ff.v.bc;
                byte byte2 = (byte)ff.w.bc;
                for(int k2 = 127; k2 >= 0; k2--)
                {
                    int l2 = (k1 * 16 + l1) * 128 + k2;
                    if(k2 <= (0 + j.nextInt(6)) - 1)
                    {
                        abyte0[l2] = (byte)ff.A.bc;
                        continue;
                    }
    ...
    public void a(bj bj1, int i1, int j1)
    {
        ey.a = true;
        int k1 = i1 * 16;
        int l1 = j1 * 16;
        ...
        for(int k2 = 0; k2 < 20; k2++)
        {
            ...
            (new eg(ff.w.bc, 32)).a(p, j, k5, l7, k12);
        }
        ...
        for(int i3 = 0; i3 < 10; i3++)
        {
            ...
            (new eg(ff.G.bc, 32)).a(p, j, l5, i8, l12);
        }
        ...
        for(int j3 = 0; j3 < 20; j3++)
        {
            ...
            (new eg(ff.J.bc, 16)).a(p, j, i6, j8, i13);
        }
        ...
        for(int k3 = 0; k3 < 20; k3++)
        {
            ...
            (new eg(ff.I.bc, 8)).a(p, j, j6, k8, j13);
        }
        ...
        for(int i4 = 0; i4 < 2; i4++)
        {
            ...
            (new eg(ff.H.bc, 8)).a(p, j, k6, l8, k13);
        }
        ...
        for(int j4 = 0; j4 < 8; j4++)
        {
            ...
            (new eg(ff.aO.bc, 7)).a(p, j, l6, i9, l13);
        }
        ...
        for(int k4 = 0; k4 < 1; k4++)
        {
            ...
            (new eg(ff.ax.bc, 7)).a(p, j, i7, j9, i14);
        }
        ...
        for(int k9 = 0; k9 < l4; k9++)
        {
            ...
            ((bc) (obj)).a(1.0D, 1.0D, 1.0D);
            ((bc) (obj)).a(p, j, j14, p.c(j14, l16), l16);
        }
        ...
        for(int l9 = 0; l9 < 2; l9++)
        {
            ...
            (new ar(ff.ae.bc)).a(p, j, k14, i17, j19);
        }
        ...
        if(j.nextInt(2) == 0)
        {
            ...
            (new ar(ff.af.bc)).a(p, j, i10, l14, j17);
        }
        if(j.nextInt(4) == 0)
        {
            ...
            (new ar(ff.ag.bc)).a(p, j, j10, i15, k17);
        }
        if(j.nextInt(8) == 0)
        {
            ...
            (new ar(ff.ah.bc)).a(p, j, k10, j15, l17);
        }
        ...
        for(int j11 = 0; j11 < 50; j11++)
        {
            ...
            (new hr(ff.B.bc)).a(p, j, i16, k18, i20);
        }
        ...
        for(int k11 = 0; k11 < 20; k11++)
        {
            ...
            (new hr(ff.D.bc)).a(p, j, j16, l18, j20);
        }
        ...
        for(int l11 = k1 + 8 + 0; l11 < k1 + 8 + 16; l11++)
        {
            ...
            {
                int i19 = p.d(l11, k16);
                if(p.d && i19 > 0 && i19 < 128 && p.a(l11, i19, k16) == 0 && p.c(l11, i19 - 1, k16).c() && p.c(l11, i19 - 1, k16) != iq.r)
                    p.d(l11, i19, k16, ff.aT.bc);
            }
