...
public class ip
{
    ...
    public void a(float f1)
    {
        ...
        if(d != 0.0F || e != 0.0F || f != 0.0F)
        {
            ...
            org.lwjgl.opengl.GL11.glTranslatef(a * f1, b * f1, c * f1);
            if(f != 0.0F)
                org.lwjgl.opengl.GL11.glRotatef(f * 57.29578F, 0.0F, 0.0F, 1.0F);
            if(e != 0.0F)
                org.lwjgl.opengl.GL11.glRotatef(e * 57.29578F, 0.0F, 1.0F, 0.0F);
            if(d != 0.0F)
                org.lwjgl.opengl.GL11.glRotatef(d * 57.29578F, 1.0F, 0.0F, 0.0F);
            org.lwjgl.opengl.GL11.glCallList(o);
    ...
    {
        o = df.a(1);
        org.lwjgl.opengl.GL11.glNewList(o, 4864);
        ho ho1 = ho.a;
