...
public class kf extends ly
{
    ...
    public boolean b(nm nm1, int j, int k, int l, int i1)
    {
        ...
        if(i1 == 1)
            return true;
        boolean flag = kf.b(nm1, j - 1, k, l) || !nm1.g(j - 1, k, l) && kf.b(nm1, j - 1, k - 1, l);
        boolean flag1 = kf.b(nm1, j + 1, k, l) || !nm1.g(j + 1, k, l) && kf.b(nm1, j + 1, k - 1, l);
        boolean flag2 = kf.b(nm1, j, k, l - 1) || !nm1.g(j, k, l - 1) && kf.b(nm1, j, k - 1, l - 1);
        boolean flag3 = kf.b(nm1, j, k, l + 1) || !nm1.g(j, k, l + 1) && kf.b(nm1, j, k - 1, l + 1);
        if(!nm1.g(j, k + 1, l))
        {
            if(nm1.g(j - 1, k, l) && kf.b(nm1, j - 1, k + 1, l))
                flag = true;
            if(nm1.g(j + 1, k, l) && kf.b(nm1, j + 1, k + 1, l))
                flag1 = true;
            if(nm1.g(j, k, l - 1) && kf.b(nm1, j, k + 1, l - 1))
                flag2 = true;
            if(nm1.g(j, k, l + 1) && kf.b(nm1, j, k + 1, l + 1))
                flag3 = true;
        }
