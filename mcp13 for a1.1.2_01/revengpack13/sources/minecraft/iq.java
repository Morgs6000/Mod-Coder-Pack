...
public class iq
{
    ...
    private void a(float f1, int i1)
    {
        ...
        float f2 = 0.07F;
        if(h.y.g)
            org.lwjgl.opengl.GL11.glTranslatef((float)(-(i1 * 2 - 1)) * f2, 0.0F, 0.0F);
        org.lwjgl.util.glu.GLU.gluPerspective(d(f1), (float)h.c / (float)h.d, 0.05F, i);
        org.lwjgl.opengl.GL11.glMatrixMode(5888);
        org.lwjgl.opengl.GL11.glLoadIdentity();
        if(h.y.g)
            org.lwjgl.opengl.GL11.glTranslatef((float)(i1 * 2 - 1) * 0.1F, 0.0F, 0.0F);
        e(f1);
        if(h.y.f)
            f(f1);
        g(f1);
    ...
    public void b(float f1)
    {
        ...
        {
            if(java.lang.System.currentTimeMillis() - l > 500L)
                h.g();
        } else
        {
            l = java.lang.System.currentTimeMillis();
        ...
        {
            org.lwjgl.opengl.GL11.glViewport(0, 0, h.c, h.d);
    ...
    public void c(float f1)
    {
        ...
        for(int i1 = 0; i1 < 2; i1++)
        {
            if(h.y.g)
                if(i1 == 0)
                    org.lwjgl.opengl.GL11.glColorMask(false, true, true, false);
                else
                    org.lwjgl.opengl.GL11.glColorMask(true, false, false, false);
            org.lwjgl.opengl.GL11.glViewport(0, 0, h.c, h.d);
            i(f1);
            org.lwjgl.opengl.GL11.glClear(16640);
        ...
        org.lwjgl.opengl.GL11.glColorMask(true, true, true, false);
    }
    ...
    private void i(float f1)
    {
        ...
        org.lwjgl.opengl.GL11.glClearColor(e, f, g, 0.0F);
    }
    ...
    private void a(int i1)
    {
        ...
        {
            org.lwjgl.opengl.GL11.glFogi(2917, 9729);
            org.lwjgl.opengl.GL11.glFogf(2915, i * 0.25F);
            org.lwjgl.opengl.GL11.glFogf(2916, i);
            if(i1 < 0)
            {
                org.lwjgl.opengl.GL11.glFogf(2915, 0.0F);
                org.lwjgl.opengl.GL11.glFogf(2916, i * 0.8F);
            }
            if(org.lwjgl.opengl.GLContext.getCapabilities().GL_NV_fog_distance)
                org.lwjgl.opengl.GL11.glFogi(34138, 34139);
        }
        org.lwjgl.opengl.GL11.glEnable(2903);
        org.lwjgl.opengl.GL11.glColorMaterial(1028, 4608);
    }
