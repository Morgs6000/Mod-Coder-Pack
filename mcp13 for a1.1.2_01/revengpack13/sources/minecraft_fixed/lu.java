...
public class lu extends lm
{
    ...
    public void a(float f1, boolean flag, int k, int l)
    {
        ...
        org.lwjgl.opengl.GL11.glBindTexture(3553, g.n.a("/gui/gui.png"));
        eu eu1 = g.g.b;
        this.k = -90F;
        b(i1 / 2 - 91, j1 - 22, 0, 0, 182, 22);
        b((i1 / 2 - 91 - 1) + eu1.d * 20, j1 - 22 - 1, 0, 22, 24, 22);
        org.lwjgl.opengl.GL11.glBindTexture(3553, g.n.a("/gui/icons.png"));
        org.lwjgl.opengl.GL11.glEnable(3042);
        org.lwjgl.opengl.GL11.glBlendFunc(775, 769);
        ...
        org.lwjgl.opengl.GL11.glRotatef(180F, 1.0F, 0.0F, 0.0F);
        ((i)null).b();
        ...
        if(org.lwjgl.input.Keyboard.isKeyDown(61))
        {
            kd1.a((new StringBuilder()).append("Minecraft Alpha v1.1.2_01 (").append(g.G).append(")").toString(), 2, 2, 0xffffff);
            kd1.a(g.l(), 2, 12, 0xffffff);
            kd1.a(g.m(), 2, 22, 0xffffff);
            kd1.a(g.n(), 2, 32, 0xffffff);
            long l2 = java.lang.Runtime.getRuntime().maxMemory();
        ...
        {
            kd1.a("Minecraft Alpha v1.1.2_01", 2, 2, 0xffffff);
        }
        if(j > 0)
        {
            float f2 = (float)j - f1;
            ...
            {
                org.lwjgl.opengl.GL11.glPushMatrix();
                org.lwjgl.opengl.GL11.glTranslatef(i1 / 2, j1 - 48, 0.0F);
                org.lwjgl.opengl.GL11.glEnable(3042);
                org.lwjgl.opengl.GL11.glBlendFunc(770, 771);
                int k4 = java.awt.Color.HSBtoRGB(f2 / 50F, 0.7F, 0.6F) & 0xffffff;
        ...
        org.lwjgl.opengl.GL11.glPushMatrix();
        org.lwjgl.opengl.GL11.glTranslatef(0.0F, j1 - 48, 0.0F);
    ...
    private void a(float f1, int k, int l)
    {
        ...
        org.lwjgl.opengl.GL11.glBlendFunc(0, 769);
        org.lwjgl.opengl.GL11.glColor4f(c, c, c, 1.0F);
        org.lwjgl.opengl.GL11.glBindTexture(3553, g.n.a("/misc/vignette.png"));
        ho ho1 = ho.a;
        ho1.b();
    ...
    private void a(int k, int l, int i1, float f1)
    {
        ...
        if(f2 > 0.0F)
        {
            org.lwjgl.opengl.GL11.glPushMatrix();
            float f3 = 1.0F + f2 / 5F;
            org.lwjgl.opengl.GL11.glTranslatef(l + 8, i1 + 12, 0.0F);
            org.lwjgl.opengl.GL11.glScalef(1.0F / f3, (f3 + 1.0F) / 2.0F, 1.0F);
            org.lwjgl.opengl.GL11.glTranslatef(-(l + 8), -(i1 + 12), 0.0F);
        }
