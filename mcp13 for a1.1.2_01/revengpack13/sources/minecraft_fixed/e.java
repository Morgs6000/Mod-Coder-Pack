    ...
    implements im
{
    ...
    public e(Minecraft minecraft, ey ey1)
    {
        ...
        if(w)
        {
            ...
            org.lwjgl.opengl.ARBOcclusionQuery.glGenQueriesARB(v);
        }
        y = df.a(3);
        org.lwjgl.opengl.GL11.glPushMatrix();
        org.lwjgl.opengl.GL11.glNewList(y, 4864);
        f();
        org.lwjgl.opengl.GL11.glEndList();
        org.lwjgl.opengl.GL11.glPopMatrix();
        ho ho1 = ho.a;
        z = y + 1;
        org.lwjgl.opengl.GL11.glNewList(z, 4864);
        byte byte1 = 64;
        int i1 = 256 / byte1 + 2;
        float f1 = 16F;
        for(int j1 = -byte1 * i1; j1 <= byte1 * i1; j1 += ((int) (byte1)))
        {
            ...
            {
                ho1.b();
                ho1.a((double)(j1 + 0), (double)f1, (double)(l1 + 0));
                ho1.a((double)(j1 + byte1), (double)f1, (double)(l1 + 0));
                ho1.a((double)(j1 + byte1), (double)f1, (double)(l1 + byte1));
                ho1.a((double)(j1 + 0), (double)f1, (double)(l1 + byte1));
                ho1.a();
            }
        ...
        org.lwjgl.opengl.GL11.glEndList();
        A = y + 2;
        org.lwjgl.opengl.GL11.glNewList(A, 4864);
        f1 = -16F;
        ho1.b();
        for(int k1 = -byte1 * i1; k1 <= byte1 * i1; k1 += ((int) (byte1)))
        {
            ...
            {
                ho1.a((double)(k1 + byte1), (double)f1, (double)(i2 + 0));
                ho1.a((double)(k1 + 0), (double)f1, (double)(i2 + 0));
                ho1.a((double)(k1 + 0), (double)f1, (double)(i2 + byte1));
                ho1.a((double)(k1 + byte1), (double)f1, (double)(i2 + byte1));
            }
    ...
    private void f()
    {
        java.util.Random random = new Random(10842L);
        ho ho1 = ho.a;
        ho1.b();
        for(int i1 = 0; i1 < 1500; i1++)
        {
            ...
            if(d5 >= 1.0D || d5 <= 0.01D)
                continue;
            d5 = 1.0D / java.lang.Math.sqrt(d5);
            d1 *= d5;
            d2 *= d5;
            d3 *= d5;
            double d6 = d1 * 100D;
            double d7 = d2 * 100D;
            double d8 = d3 * 100D;
            double d9 = java.lang.Math.atan2(d1, d3);
            double d10 = java.lang.Math.sin(d9);
            double d11 = java.lang.Math.cos(d9);
            double d12 = java.lang.Math.atan2(java.lang.Math.sqrt(d1 * d1 + d3 * d3), d2);
            double d13 = java.lang.Math.sin(d12);
            double d14 = java.lang.Math.cos(d12);
            double d15 = random.nextDouble() * 3.1415926535897931D * 2D;
            double d16 = java.lang.Math.sin(d15);
            double d17 = java.lang.Math.cos(d15);
        ...
        if(w && !t.y.g && i1 == 0)
        {
            ...
            do
            {
                ...
                for(int j2 = ((int) (byte0)); j2 < l1; j2++)
                {
                    ...
                    {
                        org.lwjgl.opengl.GL11.glTranslatef(f8, f9, f10);
                        f1 += f8;
                        f2 += f9;
                        f3 += f10;
                    }
                    org.lwjgl.opengl.ARBOcclusionQuery.glBeginQueryARB(35092, n[j2].z);
                    n[j2].d();
                    org.lwjgl.opengl.ARBOcclusionQuery.glEndQueryARB(35092);
                    n[j2].y = true;
                }
    ...
    private void a(int i1, int j1)
    {
        for(int k1 = i1; k1 < j1; k1++)
        {
            if(!n[k1].y)
                continue;
            c.clear();
            org.lwjgl.opengl.ARBOcclusionQuery.glGetQueryObjectuARB(n[k1].z, 34919, c);
            if(c.get(0) != 0)
            {
                n[k1].y = false;
                c.clear();
                org.lwjgl.opengl.ARBOcclusionQuery.glGetQueryObjectuARB(n[k1].z, 34918, c);
                n[k1].x = c.get(0) != 0;
            }
        }
    ...
    public void a(float f1)
    {
        ...
        org.lwjgl.opengl.GL11.glColor3f(f2, f3, f4);
        ho ho1 = ho.a;
        org.lwjgl.opengl.GL11.glDepthMask(false);
        org.lwjgl.opengl.GL11.glEnable(2912);
        org.lwjgl.opengl.GL11.glColor3f(f2, f3, f4);
        org.lwjgl.opengl.GL11.glCallList(z);
        org.lwjgl.opengl.GL11.glEnable(3553);
        org.lwjgl.opengl.GL11.glDisable(2912);
        org.lwjgl.opengl.GL11.glDisable(3008);
        org.lwjgl.opengl.GL11.glEnable(3042);
        org.lwjgl.opengl.GL11.glBlendFunc(1, 1);
        org.lwjgl.opengl.GL11.glPushMatrix();
        float f7 = 0.0F;
        float f9 = 0.0F;
        float f10 = 0.0F;
        ...
        ho1.a();
        f11 = 20F;
        org.lwjgl.opengl.GL11.glBindTexture(3553, l.a("/terrain/moon.png"));
        ho1.b();
        ho1.a(-f11, -100D, f11, 1.0D, 1.0D);
        ho1.a(f11, -100D, f11, 0.0D, 1.0D);
        ho1.a(f11, -100D, -f11, 0.0D, 0.0D);
        ...
        if(f12 > 0.0F)
        {
            ...
            org.lwjgl.opengl.GL11.glCallList(y);
        }
        org.lwjgl.opengl.GL11.glColor4f(1.0F, 1.0F, 1.0F, 1.0F);
        ...
        org.lwjgl.opengl.GL11.glEnable(2912);
        org.lwjgl.opengl.GL11.glPopMatrix();
        org.lwjgl.opengl.GL11.glColor3f(f2 * 0.2F + 0.04F, f3 * 0.2F + 0.04F, f4 * 0.6F + 0.1F);
        org.lwjgl.opengl.GL11.glDisable(3553);
        org.lwjgl.opengl.GL11.glCallList(A);
        org.lwjgl.opengl.GL11.glEnable(3553);
        org.lwjgl.opengl.GL11.glDepthMask(true);
    }
    ...
    public void c(float f1)
    {
        ...
        org.lwjgl.opengl.GL11.glScalef(f3, 1.0F, f3);
    ...
    public void a(dm dm1, mf mf1, int i1, ev ev, float f1)
    {
        ...
        if(i1 == 0)
        {
            if(i > 0.0F)
            {
                org.lwjgl.opengl.GL11.glBlendFunc(774, 768);
                ...
                org.lwjgl.opengl.GL11.glPolygonOffset(0.0F, 0.0F);
                org.lwjgl.opengl.GL11.glDisable(32823);
                org.lwjgl.opengl.GL11.glEnable(3008);
                org.lwjgl.opengl.GL11.glDepthMask(true);
                org.lwjgl.opengl.GL11.glPopMatrix();
            }
    ...
    public void b(dm dm1, mf mf1, int i1, ev ev, float f1)
    {
        if(i1 == 0 && mf1.a == 0)
        {
            org.lwjgl.opengl.GL11.glEnable(3042);
            org.lwjgl.opengl.GL11.glBlendFunc(770, 771);
            org.lwjgl.opengl.GL11.glColor4f(0.0F, 0.0F, 0.0F, 0.4F);
