   ...
   protected void func_74191_a(Slot p_74191_1_, int p_74191_2_, int p_74191_3_, int p_74191_4_) {
      ...
      if(p_74191_1_ != null) {
         if(p_74191_1_ == this.field_74235_v && var5) {
            for(int var11 = 0; var11 < this.field_73882_e.field_71439_g.field_71069_bz.func_75138_a().size(); ++var11) {
               this.field_73882_e.field_71442_b.func_78761_a((ItemStack)null, var11);
            }
            ...
            ItemStack var10 = this.field_74193_d.func_75139_a(p_74191_1_.field_75222_d).func_75211_c();
            this.field_73882_e.field_71442_b.func_78761_a(var10, p_74191_1_.field_75222_d - this.field_74193_d.field_75151_b.size() + 9 + 36);
         }
      } else {
         var6 = this.field_73882_e.field_71439_g.field_71071_by;
