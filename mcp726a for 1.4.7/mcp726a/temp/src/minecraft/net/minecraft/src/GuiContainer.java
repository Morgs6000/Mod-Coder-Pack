...
public abstract class GuiContainer extends GuiScreen {
   ...
   public void func_73863_a(int p_73863_1_, int p_73863_2_, float p_73863_3_) {
      ...
      for(int var13 = 0; var13 < this.field_74193_d.field_75151_b.size(); ++var13) {
         ...
         if(this.func_74186_a(var15, p_73863_1_, p_73863_2_)) {
      ...
      if(var16 != null) {
         ...
         this.func_85044_b(var16, p_73863_1_ - var4 - var17, p_73863_2_ - var5 - var9);
      }
      ...
      if(this.field_85045_v != null) {
         ...
         int var12 = this.field_85048_s + (int)((float)var10 * var18);
   ...
   private void func_85044_b(ItemStack p_85044_1_, int p_85044_2_, int p_85044_3_) {
      ...
      field_74196_a.func_77021_b(this.field_73886_k, this.field_73882_e.field_71446_o, p_85044_1_, p_85044_2_, p_85044_3_ - (this.field_85050_q == null?0:8));
   ...
   protected void func_85041_a(int p_85041_1_, int p_85041_2_, int p_85041_3_, long p_85041_4_) {
      if(this.field_85051_p != null && this.field_73882_e.field_71474_y.field_85185_A) {
         if(p_85041_3_ == 0 || p_85041_3_ == 1) {
            ...
            } else if(this.field_85050_q.field_77994_a > 1 && var6 != null && this.func_92031_b(var6)) {
   ...
   private boolean func_92031_b(Slot p_92031_1_) {
      ...
      if(p_92031_1_ != null && p_92031_1_.func_75216_d() && this.field_85050_q != null && ItemStack.func_77970_a(p_92031_1_.func_75211_c(), this.field_85050_q)) {
         var2 |= p_92031_1_.func_75211_c().field_77994_a + this.field_85050_q.field_77994_a <= this.field_85050_q.func_77976_d();
      }
