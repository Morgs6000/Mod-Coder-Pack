...
public class EntityDragon extends EntityLiving implements IBossDisplayData, IEntityMultiPart {
   ...
   private void func_70969_j() {
      if(this.field_70992_bH != null) {
         if(this.field_70992_bH.field_70128_L) {
            if(!this.field_70170_p.field_72995_K) {
               this.func_70965_a(this.field_70986_h, DamageSource.field_76378_k, 10);
            }

            this.field_70992_bH = null;
         } else if(this.field_70173_aa % 10 == 0 && this.field_70734_aK < this.func_70667_aM()) {
            ++this.field_70734_aK;
         }
      }
   ...
   private void func_70975_a(int p_70975_1_, int p_70975_2_) {
               ...
               if(var12 <= ((double)var4 - 0.5D) * ((double)var4 - 0.5D)) {
                  if(var5 < var3) {
                     if(var12 <= ((double)(var4 - 1) - 0.5D) * ((double)(var4 - 1) - 0.5D)) {
                        this.field_70170_p.func_72859_e(var6, var5, var7, Block.field_71986_z.field_71990_ca);
                     }
                  } else if(var5 > var3) {
                     this.field_70170_p.func_72859_e(var6, var5, var7, 0);
                  } else if(var12 > ((double)(var4 - 1) - 0.5D) * ((double)(var4 - 1) - 0.5D)) {
                     this.field_70170_p.func_72859_e(var6, var5, var7, Block.field_71986_z.field_71990_ca);
                  } else {
                     this.field_70170_p.func_72859_e(var6, var5, var7, Block.field_72102_bH.field_71990_ca);
                  }
               }
            }
         }
      ...
      this.field_70170_p.func_72859_e(p_70975_1_, var3 + 0, p_70975_2_, Block.field_71986_z.field_71990_ca);
      this.field_70170_p.func_72859_e(p_70975_1_, var3 + 1, p_70975_2_, Block.field_71986_z.field_71990_ca);
      this.field_70170_p.func_72859_e(p_70975_1_, var3 + 2, p_70975_2_, Block.field_71986_z.field_71990_ca);
      this.field_70170_p.func_72859_e(p_70975_1_ - 1, var3 + 2, p_70975_2_, Block.field_72069_aq.field_71990_ca);
      this.field_70170_p.func_72859_e(p_70975_1_ + 1, var3 + 2, p_70975_2_, Block.field_72069_aq.field_71990_ca);
      this.field_70170_p.func_72859_e(p_70975_1_, var3 + 2, p_70975_2_ - 1, Block.field_72069_aq.field_71990_ca);
      this.field_70170_p.func_72859_e(p_70975_1_, var3 + 2, p_70975_2_ + 1, Block.field_72069_aq.field_71990_ca);
      this.field_70170_p.func_72859_e(p_70975_1_, var3 + 3, p_70975_2_, Block.field_71986_z.field_71990_ca);
      this.field_70170_p.func_72859_e(p_70975_1_, var3 + 4, p_70975_2_, Block.field_72084_bK.field_71990_ca);
