...
public class GuiAchievements extends GuiScreen {
   ...
   protected void func_74110_b(int p_74110_1_, int p_74110_2_, float p_74110_3_) {
      ...
      for(var24 = 0; var24 < AchievementList.field_76007_e.size(); ++var24) {
         ...
         if(var26 >= -24 && var27 >= -24 && var26 <= 224 && var27 <= 155) {
            ...
            if(var35.func_75984_f()) {
               this.func_73729_b(var39 - 2, var40 - 2, 26, 202, 26, 26);
            } else {
               this.func_73729_b(var39 - 2, var40 - 2, 0, 202, 26, 26);
            }

            if(!this.field_74126_x.func_77442_b(var35)) {
               float var41 = 0.1F;
               GL11.glColor4f(var41, var41, var41, 1.0F);
               var34.field_77024_a = false;
            }

            GL11.glEnable(2896);
            GL11.glEnable(2884);
            var34.func_82406_b(this.field_73882_e.field_71466_p, this.field_73882_e.field_71446_o, var35.field_75990_d, var39 + 3, var40 + 3);
            GL11.glDisable(2896);
            if(!this.field_74126_x.func_77442_b(var35)) {
               var34.field_77024_a = true;
            }

            GL11.glColor4f(1.0F, 1.0F, 1.0F, 1.0F);
            if(p_74110_1_ >= var10 && p_74110_2_ >= var11 && p_74110_1_ < var10 + 224 && p_74110_2_ < var11 + 155 && p_74110_1_ >= var39 && p_74110_1_ <= var39 + 22 && p_74110_2_ >= var40 && p_74110_2_ <= var40 + 22) {
               var32 = var35;
            }
         }
      }
      ...
      if(var32 != null) {
         String var36 = StatCollector.func_74838_a(var32.func_75970_i());
         String var37 = var32.func_75989_e();
         var26 = p_74110_1_ + 12;
         var27 = p_74110_2_ - 4;
         if(this.field_74126_x.func_77442_b(var32)) {
            var39 = Math.max(this.field_73886_k.func_78256_a(var36), 120);
            var40 = this.field_73886_k.func_78267_b(var37, var39);
            if(this.field_74126_x.func_77443_a(var32)) {
               var40 += 12;
            }

            this.func_73733_a(var26 - 3, var27 - 3, var26 + var39 + 3, var27 + var40 + 3 + 12, -1073741824, -1073741824);
            this.field_73886_k.func_78279_b(var37, var26, var27 + 12, var39, -6250336);
            if(this.field_74126_x.func_77443_a(var32)) {
               this.field_73886_k.func_78261_a(StatCollector.func_74838_a("achievement.taken"), var26, var27 + var40 + 4, -7302913);
            }
         } else {
            var39 = Math.max(this.field_73886_k.func_78256_a(var36), 120);
            String var42 = StatCollector.func_74837_a("achievement.requires", new Object[]{StatCollector.func_74838_a(var32.field_75992_c.func_75970_i())});
            var30 = this.field_73886_k.func_78267_b(var42, var39);
            this.func_73733_a(var26 - 3, var27 - 3, var26 + var39 + 3, var27 + var30 + 12 + 3, -1073741824, -1073741824);
            this.field_73886_k.func_78279_b(var42, var26, var27 + 12, var39, -9416624);
         }

         this.field_73886_k.func_78261_a(var36, var26, var27, this.field_74126_x.func_77442_b(var32)?(var32.func_75984_f()?-128:-1):(var32.func_75984_f()?-8355776:-8355712));
      }
