...
public class TcpConnection implements INetworkManager {
   ...
   public TcpConnection(Socket p_i3287_1_, String p_i3287_2_, NetHandler p_i3287_3_) throws IOException {
      this(p_i3287_1_, p_i3287_2_, p_i3287_3_, (PrivateKey)null);
   }
