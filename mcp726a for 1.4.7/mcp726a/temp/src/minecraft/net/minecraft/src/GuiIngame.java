...
public class GuiIngame extends Gui {
   ...
   public void func_73830_a(float p_73830_1_, boolean p_73830_2_, int p_73830_3_, int p_73830_4_) {
      ...
      if(!this.field_73839_d.field_71442_b.func_78747_a()) {
         ...
         if(this.field_73839_d.field_71442_b.func_78755_b()) {
            ...
            for(var25 = 0; var25 < 10; ++var25) {
               ...
               var29 = var46;
               if(var12 <= 4) {
                  var29 = var46 + this.field_73842_c.nextInt(2);
               }
            ...
            for(var25 = 0; var25 < 10; ++var25) {
               ...
               if(this.field_73839_d.field_71439_g.func_71024_bL().func_75115_e() <= 0.0F && this.field_73837_f % (var16 * 3 + 1) == 0) {
                  var26 = var46 + (this.field_73842_c.nextInt(3) - 1);
               }
               ...
               this.func_73729_b(var29, var26, 16 + var53 * 9, 27, 9, 9);
               if(var14) {
                  if(var25 * 2 + 1 < var17) {
                     this.func_73729_b(var29, var26, var52 + 54, 27, 9, 9);
                  }

                  if(var25 * 2 + 1 == var17) {
                     this.func_73729_b(var29, var26, var52 + 63, 27, 9, 9);
                  }
               }

               if(var25 * 2 + 1 < var16) {
                  this.func_73729_b(var29, var26, var52 + 36, 27, 9, 9);
               }

               if(var25 * 2 + 1 == var16) {
                  this.func_73729_b(var29, var26, var52 + 45, 27, 9, 9);
               }
            }
            ...
            if(this.field_73839_d.field_71439_g.func_70055_a(Material.field_76244_g)) {
               ...
               var52 = MathHelper.func_76143_f((double)var25 * 10.0D / 300.0D) - var26;
      ...
      if(this.field_73839_d.field_71442_b.func_78763_f() && this.field_73839_d.field_71439_g.field_71068_ca > 0) {
         ...
         var36 = (var6 - var8.func_78256_a(var34)) / 2;
         var40 = var7 - 31 - 4;
         var8.func_78276_b(var34, var36 + 1, var40, 0);
         var8.func_78276_b(var34, var36 - 1, var40, 0);
         var8.func_78276_b(var34, var36, var40 + 1, 0);
         var8.func_78276_b(var34, var36, var40 - 1, 0);
         var8.func_78276_b(var34, var36, var40, var12);
         this.field_73839_d.field_71424_I.func_76319_b();
      }
      ...
      if(this.field_73839_d.field_71474_y.field_92117_D) {
         ...
         if(this.field_92017_k > 0 && this.field_92016_l != null) {
            ...
            var36 = (int)((float)this.field_92017_k * 256.0F / 10.0F);
            if(var36 > 255) {
               var36 = 255;
            }
            ...
            if(var36 > 0) {
               ...
               GL11.glEnable(3042);
               GL11.glBlendFunc(770, 771);
               var8.func_78261_a(var35, var12, var13, 16777215 + (var36 << 24));
               GL11.glDisable(3042);
               GL11.glPopMatrix();
            }
         }
      ...
      if(this.field_73839_d.field_71474_y.field_74330_P) {
         ...
         GL11.glPushMatrix();
         var8.func_78261_a("Minecraft 1.4.7 (" + this.field_73839_d.field_71426_K + ")", 2, 2, 16777215);
         ...
         var46 = MathHelper.func_76128_c(this.field_73839_d.field_71439_g.field_70165_t);
         ...
         this.func_73731_b(var8, String.format("x: %.5f (%d) // c: %d (%d)", new Object[]{Double.valueOf(this.field_73839_d.field_71439_g.field_70165_t), Integer.valueOf(var46), Integer.valueOf(var46 >> 4), Integer.valueOf(var46 & 15)}), 2, 64, 14737632);
         ...
         if(this.field_73839_d.field_71441_e != null && this.field_73839_d.field_71441_e.func_72899_e(var46, var22, var23)) {
            Chunk var51 = this.field_73839_d.field_71441_e.func_72938_d(var46, var23);
            this.func_73731_b(var8, "lc: " + (var51.func_76625_h() + 15) + " b: " + var51.func_76591_a(var46 & 15, var23 & 15, this.field_73839_d.field_71441_e.func_72959_q()).field_76791_y + " bl: " + var51.func_76614_a(EnumSkyBlock.Block, var46 & 15, var22, var23 & 15) + " sl: " + var51.func_76614_a(EnumSkyBlock.Sky, var46 & 15, var22, var23 & 15) + " rl: " + var51.func_76629_c(var46 & 15, var22, var23 & 15, 0), 2, 96, 14737632);
         }

         this.func_73731_b(var8, String.format("ws: %.3f, fs: %.3f, g: %b, fl: %d", new Object[]{Float.valueOf(this.field_73839_d.field_71439_g.field_71075_bZ.func_75094_b()), Float.valueOf(this.field_73839_d.field_71439_g.field_71075_bZ.func_75093_a()), Boolean.valueOf(this.field_73839_d.field_71439_g.field_70122_E), Integer.valueOf(this.field_73839_d.field_71441_e.func_72976_f(var46, var23))}), 2, 104, 14737632);
         GL11.glPopMatrix();
         this.field_73839_d.field_71424_I.func_76319_b();
      }
      ...
      if(this.field_73839_d.field_71474_y.field_74321_H.field_74513_e && (!this.field_73839_d.func_71387_A() || this.field_73839_d.field_71439_g.field_71174_a.field_72559_c.size() > 1)) {
         ...
         List var38 = var42.field_72559_c;
         var13 = var42.field_72556_d;
         var36 = var13;

         for(var40 = 1; var36 > 20; var36 = (var13 + var40 - 1) / var40) {
            ++var40;
         }
         ...
         byte var44 = 10;
         func_73734_a(var17 - 1, var44 - 1, var17 + var16 * var40, var44 + 9 * var36, Integer.MIN_VALUE);

         for(var19 = 0; var19 < var13; ++var19) {
            var20 = var17 + var19 % var40 * var16;
            var46 = var44 + var19 / var40 * 9;
            func_73734_a(var20, var46, var20 + var16 - 1, var46 + 8, 553648127);
            GL11.glColor4f(1.0F, 1.0F, 1.0F, 1.0F);
            GL11.glEnable(3008);
            if(var19 < var38.size()) {
               GuiPlayerInfo var47 = (GuiPlayerInfo)var38.get(var19);
               var8.func_78261_a(var47.field_78831_a, var20, var46, 16777215);
               this.field_73839_d.field_71446_o.func_78342_b(this.field_73839_d.field_71446_o.func_78341_b("/gui/icons.png"));
               byte var48 = 0;
               boolean var49 = false;
               byte var50;
               if(var47.field_78829_b < 0) {
                  var50 = 5;
               } else if(var47.field_78829_b < 150) {
                  var50 = 0;
               } else if(var47.field_78829_b < 300) {
                  var50 = 1;
               } else if(var47.field_78829_b < 600) {
                  var50 = 2;
               } else if(var47.field_78829_b < 1000) {
                  var50 = 3;
               } else {
                  var50 = 4;
               }
               ...
               this.func_73729_b(var20 + var16 - 12, var46, 0 + var48 * 10, 176 + var50 * 8, 10, 8);
               this.field_73735_i -= 100.0F;
            }
         }
      }
