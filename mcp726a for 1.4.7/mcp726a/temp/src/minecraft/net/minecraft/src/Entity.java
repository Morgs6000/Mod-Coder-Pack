...
public abstract class Entity {
   ...
   public void func_70091_d(double p_70091_1_, double p_70091_3_, double p_70091_5_) {
      if(this.field_70145_X) {
         ...
         List var34 = this.field_70170_p.func_72945_a(this, this.field_70121_D.func_72321_a(p_70091_1_, p_70091_3_, p_70091_5_));

         for(int var22 = 0; var22 < var34.size(); ++var22) {
            p_70091_3_ = ((AxisAlignedBB)var34.get(var22)).func_72323_b(this.field_70121_D, p_70091_3_);
         }
         ...
         for(var23 = 0; var23 < var34.size(); ++var23) {
            p_70091_1_ = ((AxisAlignedBB)var34.get(var23)).func_72316_a(this.field_70121_D, p_70091_1_);
         }
         ...
         for(var23 = 0; var23 < var34.size(); ++var23) {
            p_70091_5_ = ((AxisAlignedBB)var34.get(var23)).func_72322_c(this.field_70121_D, p_70091_5_);
         }
         ...
         if(this.field_70138_W > 0.0F && var35 && (var20 || this.field_70139_V < 0.05F) && (var13 != p_70091_1_ || var17 != p_70091_5_)) {
            ...
            var34 = this.field_70170_p.func_72945_a(this, this.field_70121_D.func_72321_a(var13, p_70091_3_, var17));

            for(var30 = 0; var30 < var34.size(); ++var30) {
               p_70091_3_ = ((AxisAlignedBB)var34.get(var30)).func_72323_b(this.field_70121_D, p_70091_3_);
            }
            ...
            for(var30 = 0; var30 < var34.size(); ++var30) {
               p_70091_1_ = ((AxisAlignedBB)var34.get(var30)).func_72316_a(this.field_70121_D, p_70091_1_);
            }
            ...
            for(var30 = 0; var30 < var34.size(); ++var30) {
               p_70091_5_ = ((AxisAlignedBB)var34.get(var30)).func_72322_c(this.field_70121_D, p_70091_5_);
            }
         ...
         if(this.func_70041_e_() && !var20 && this.field_70154_o == null) {
            ...
            if(this.field_82151_R > (float)this.field_70150_b && var32 > 0) {
               ...
               if(this.func_70090_H()) {
                  float var40 = MathHelper.func_76133_a(this.field_70159_w * this.field_70159_w * 0.20000000298023224D + this.field_70181_x * this.field_70181_x + this.field_70179_y * this.field_70179_y * 0.20000000298023224D) * 0.35F;
                  if(var40 > 1.0F) {
                     var40 = 1.0F;
                  }

                  this.func_85030_a("liquid.swim", var40, 1.0F + (this.field_70146_Z.nextFloat() - this.field_70146_Z.nextFloat()) * 0.4F);
               }
