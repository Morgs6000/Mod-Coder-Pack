...
public class RenderGlobal implements IWorldAccess {
   ...
   public RenderGlobal(Minecraft p_i3194_1_, RenderEngine p_i3194_2_) {
      ...
      for(var9 = -var7 * var8; var9 <= var7 * var8; var9 += var7) {
         for(var10 = -var7 * var8; var10 <= var7 * var8; var10 += var7) {
            var5.func_78382_b();
            var5.func_78377_a((double)(var9 + 0), (double)var6, (double)(var10 + 0));
            var5.func_78377_a((double)(var9 + var7), (double)var6, (double)(var10 + 0));
            var5.func_78377_a((double)(var9 + var7), (double)var6, (double)(var10 + var7));
            var5.func_78377_a((double)(var9 + 0), (double)var6, (double)(var10 + var7));
            var5.func_78381_a();
         }
      }
   ...
   public void func_72712_a() {
      if(this.field_72769_h != null) {
         ...
         if(this.field_72769_h != null) {
            EntityLiving var7 = this.field_72777_q.field_71451_h;
            if(var7 != null) {
   ...
   private int func_72724_a(int p_72724_1_, int p_72724_2_, int p_72724_3_, double p_72724_4_) {
      ...
      EntityLiving var19 = this.field_72777_q.field_71451_h;
   ...
   public void func_72714_a(float p_72714_1_) {
      if(this.field_72777_q.field_71441_e.field_73011_w.field_76574_g == 1) {
         ...
         int var28 = this.field_72769_h.func_72853_d(p_72714_1_);
         int var29 = var28 % 4;
         int var30 = var28 / 4 % 2;
         ...
         if(var21 != null) {
            ...
            if(var15 * var15 + var17 * var17 + var19 * var19 > var22 * var22) {
               ...
               if(p_72726_1_.equals("bubble")) {
                  ...
                  String[] var28 = p_72726_1_.split("_", 3);
