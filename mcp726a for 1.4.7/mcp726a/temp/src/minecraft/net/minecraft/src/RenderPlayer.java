   ...
   protected void func_77100_a(EntityPlayer p_77100_1_, float p_77100_2_) {
      ...
      if(p_77100_1_.field_71092_bJ.equals("deadmau5") && this.func_76984_a(p_77100_1_.field_70120_cr, (String)null)) {
         for(int var20 = 0; var20 < 2; ++var20) {
            float var23 = p_77100_1_.field_70126_B + (p_77100_1_.field_70177_z - p_77100_1_.field_70126_B) * p_77100_2_ - (p_77100_1_.field_70760_ar + (p_77100_1_.field_70761_aq - p_77100_1_.field_70760_ar) * p_77100_2_);
      ...
      if(this.func_76984_a(p_77100_1_.field_71084_cw, (String)null) && !p_77100_1_.func_82150_aj() && !p_77100_1_.func_82238_cc()) {
         ...
         double var21 = p_77100_1_.field_71091_bM + (p_77100_1_.field_71094_bP - p_77100_1_.field_71091_bM) * (double)p_77100_2_ - (p_77100_1_.field_70169_q + (p_77100_1_.field_70165_t - p_77100_1_.field_70169_q) * (double)p_77100_2_);
      ...
      if(var22 != null) {
         ...
         if(var22.field_77993_c < 256 && RenderBlocks.func_78597_b(Block.field_71973_m[var22.field_77993_c].func_71857_b())) {
         ...
         } else if(var22.field_77993_c == Item.field_77707_k.field_77779_bT) {
            var7 = 0.625F;
            ...
            GL11.glRotatef(45.0F, 0.0F, 1.0F, 0.0F);
         } else if(Item.field_77698_e[var22.field_77993_c].func_77662_d()) {
            var7 = 0.625F;
            if(Item.field_77698_e[var22.field_77993_c].func_77629_n_()) {
               GL11.glRotatef(180.0F, 0.0F, 0.0F, 1.0F);
               GL11.glTranslatef(0.0F, -0.125F, 0.0F);
            }

            if(p_77100_1_.func_71052_bv() > 0 && var25 == EnumAction.block) {
         ...
         if(var22.func_77973_b().func_77623_v()) {
            for(var27 = 0; var27 <= 1; ++var27) {
               ...
               this.field_76990_c.field_78721_f.func_78443_a(p_77100_1_, var22, var27);
            }
         } else {
            var27 = var22.func_77973_b().func_82790_a(var22, 0);
            ...
            this.field_76990_c.field_78721_f.func_78443_a(p_77100_1_, var22, 0);
         }
