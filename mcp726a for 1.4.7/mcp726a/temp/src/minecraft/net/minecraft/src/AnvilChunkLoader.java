...
public class AnvilChunkLoader implements IChunkLoader, IThreadedFileIO {
   ...
   private Chunk func_75823_a(World p_75823_1_, NBTTagCompound p_75823_2_) {
      ...
      NBTTagList var15 = p_75823_2_.func_74761_m("Entities");
      if(var15 != null) {
         for(int var16 = 0; var16 < var15.func_74745_c(); ++var16) {
            NBTTagCompound var18 = (NBTTagCompound)var15.func_74743_b(var16);
            Entity var20 = EntityList.func_75615_a(var18, p_75823_1_);
            var5.field_76644_m = true;
            if(var20 != null) {
               var5.func_76612_a(var20);
            }
         }
      }

      NBTTagList var17 = p_75823_2_.func_74761_m("TileEntities");
      if(var17 != null) {
         for(int var19 = 0; var19 < var17.func_74745_c(); ++var19) {
            NBTTagCompound var22 = (NBTTagCompound)var17.func_74743_b(var19);
            TileEntity var14 = TileEntity.func_70317_c(var22);
            if(var14 != null) {
               var5.func_76620_a(var14);
            }
         }
      }

      if(p_75823_2_.func_74764_b("TileTicks")) {
         NBTTagList var21 = p_75823_2_.func_74761_m("TileTicks");
         if(var21 != null) {
            for(int var23 = 0; var23 < var21.func_74745_c(); ++var23) {
               NBTTagCompound var24 = (NBTTagCompound)var21.func_74743_b(var23);
               p_75823_1_.func_72892_b(var24.func_74762_e("x"), var24.func_74762_e("y"), var24.func_74762_e("z"), var24.func_74762_e("i"), var24.func_74762_e("t"));
            }
         }
      }
