...
public class MapItemRenderer {
   ...
   public void func_78319_a(EntityPlayer p_78319_1_, RenderEngine p_78319_2_, MapData p_78319_3_) {
      ...
      for(Iterator var20 = p_78319_3_.field_76203_h.values().iterator(); var20.hasNext(); ++var19) {
         ...
         var17.func_78382_b();
         var17.func_78374_a(-1.0D, 1.0D, (double)((float)var19 * 0.001F), (double)var22, (double)var23);
         var17.func_78374_a(1.0D, 1.0D, (double)((float)var19 * 0.001F), (double)var24, (double)var23);
         var17.func_78374_a(1.0D, -1.0D, (double)((float)var19 * 0.001F), (double)var24, (double)var25);
         var17.func_78374_a(-1.0D, -1.0D, (double)((float)var19 * 0.001F), (double)var22, (double)var25);
         var17.func_78381_a();
         GL11.glPopMatrix();
      }
