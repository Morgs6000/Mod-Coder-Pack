...
class GuiSlotServer extends GuiSlot {
   ...
   protected void func_77213_a(int p_77213_1_, boolean p_77213_2_) {
      if(p_77213_1_ < GuiMultiplayer.func_74006_a(this.field_77250_a).func_78856_c() + GuiMultiplayer.func_74003_b(this.field_77250_a).size()) {
         ...
         boolean var5 = GuiMultiplayer.func_74020_c(this.field_77250_a) >= 0 && GuiMultiplayer.func_74020_c(this.field_77250_a) < this.func_77217_a() && (var4 == null || var4.field_82821_f == 51);
   ...
   private void func_77247_d(int p_77247_1_, int p_77247_2_, int p_77247_3_, int p_77247_4_, Tessellator p_77247_5_) {
      ...
      this.field_77250_a.field_73882_e.field_71446_o.func_78342_b(this.field_77250_a.field_73882_e.field_71446_o.func_78341_b("/gui/icons.png"));
      byte var15 = 0;
      boolean var11 = false;
      String var12 = "";
      int var16;
