...
public class ItemRenderer {
   ...
   public static void func_78439_a(Tessellator p_78439_0_, float p_78439_1_, float p_78439_2_, float p_78439_3_, float p_78439_4_, float p_78439_5_) {
      ...
      p_78439_0_.func_78374_a((double)var6, 0.0D, 0.0D, (double)p_78439_3_, (double)p_78439_4_);
      p_78439_0_.func_78374_a((double)var6, 1.0D, 0.0D, (double)p_78439_3_, (double)p_78439_2_);
      p_78439_0_.func_78374_a(0.0D, 1.0D, 0.0D, (double)p_78439_1_, (double)p_78439_2_);
      p_78439_0_.func_78381_a();
      p_78439_0_.func_78382_b();
      p_78439_0_.func_78375_b(0.0F, 0.0F, -1.0F);
      p_78439_0_.func_78374_a(0.0D, 1.0D, (double)(0.0F - p_78439_5_), (double)p_78439_1_, (double)p_78439_2_);
      p_78439_0_.func_78374_a((double)var6, 1.0D, (double)(0.0F - p_78439_5_), (double)p_78439_3_, (double)p_78439_2_);
      p_78439_0_.func_78374_a((double)var6, 0.0D, (double)(0.0F - p_78439_5_), (double)p_78439_3_, (double)p_78439_4_);
      p_78439_0_.func_78374_a(0.0D, 0.0D, (double)(0.0F - p_78439_5_), (double)p_78439_1_, (double)p_78439_4_);
      p_78439_0_.func_78381_a();
      p_78439_0_.func_78382_b();
      ...
      for(var7 = 0; var7 < 16; ++var7) {
         ...
         p_78439_0_.func_78374_a(0.0D, (double)var10, (double)(0.0F - p_78439_5_), (double)p_78439_1_, (double)var9);
      }
   ...
   public void func_78440_a(float p_78440_1_) {
      ...
      if(var17 != null && var17.field_77993_c == Item.field_77744_bd.field_77779_bT) {
         ...
         var21 = MathHelper.func_76126_a(var19 * 3.1415927F);
         var10 = MathHelper.func_76126_a(MathHelper.func_76129_c(var19) * 3.1415927F);
         GL11.glTranslatef(-var10 * 0.4F, MathHelper.func_76126_a(MathHelper.func_76129_c(var19) * 3.1415927F * 2.0F) * 0.2F, -var21 * 0.2F);
         ...
         var19 = -MathHelper.func_76134_b(var19 * 3.1415927F) * 0.5F + 0.5F;
         ...
         Tessellator var27 = Tessellator.field_78398_a;
         GL11.glNormal3f(0.0F, 0.0F, -1.0F);
         var27.func_78382_b();
         byte var28 = 7;
         var27.func_78374_a((double)(0 - var28), (double)(128 + var28), 0.0D, 0.0D, 1.0D);
         var27.func_78374_a((double)(128 + var28), (double)(128 + var28), 0.0D, 1.0D, 1.0D);
         ...
         if(var3.func_71052_bv() > 0) {
            EnumAction var20 = var17.func_77975_n();
         ...
         GL11.glEnable('\u803a');
         var19 = var3.func_70678_g(p_78440_1_);
         var21 = MathHelper.func_76126_a(var19 * var19 * 3.1415927F);
         var10 = MathHelper.func_76126_a(MathHelper.func_76129_c(var19) * 3.1415927F);
         ...
         var21 = MathHelper.func_76126_a(var19 * 3.1415927F);
         var10 = MathHelper.func_76126_a(MathHelper.func_76129_c(var19) * 3.1415927F);
         GL11.glTranslatef(-var10 * 0.3F, MathHelper.func_76126_a(MathHelper.func_76129_c(var19) * 3.1415927F * 2.0F) * 0.4F, -var21 * 0.4F);
