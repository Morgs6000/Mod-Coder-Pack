         ...
         for(var1 = 1; var1 < 3; ++var1) {
            if(this.field_70173_aa >= this.field_82223_h[var1 - 1]) {
               ...
               if(var13 > 0) {
                  ...
                  List var14 = this.field_70170_p.func_82733_a(EntityLiving.class, this.field_70121_D.func_72314_b(20.0D, 8.0D, 20.0D), field_82219_bJ);

                  for(int var17 = 0; var17 < 10 && !var14.isEmpty(); ++var17) {
                     EntityLiving var5 = (EntityLiving)var14.get(this.field_70146_Z.nextInt(var14.size()));
               ...
               for(int var19 = -1; var19 <= 1; ++var19) {
                  for(int var20 = -1; var20 <= 1; ++var20) {
                     for(int var7 = 0; var7 <= 3; ++var7) {
                        ...
                        int var11 = this.field_70170_p.func_72798_a(var21, var9, var10);
                        if(var11 > 0 && var11 != Block.field_71986_z.field_71990_ca && var11 != Block.field_72102_bH.field_71990_ca && var11 != Block.field_72104_bI.field_71990_ca) {
                           int var12 = this.field_70170_p.func_72805_g(var21, var9, var10);
                           this.field_70170_p.func_72926_e(2001, var21, var9, var10, var11 + (var12 << 12));
                           Block.field_71973_m[var11].func_71897_c(this.field_70170_p, var21, var9, var10, var12, 0);
                           this.field_70170_p.func_72859_e(var21, var9, var10, 0);
                           var18 = true;
                        }
                     }
                  }
