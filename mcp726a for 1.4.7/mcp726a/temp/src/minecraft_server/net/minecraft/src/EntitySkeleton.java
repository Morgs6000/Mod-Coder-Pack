...
public class EntitySkeleton extends EntityMob implements IRangedAttackMob {
   ...
   public void func_82196_d(EntityLiving p_82196_1_) {
      EntityArrow var2 = new EntityArrow(this.field_70170_p, this, p_82196_1_, 1.6F, 12.0F);
      int var3 = EnchantmentHelper.func_77506_a(Enchantment.field_77345_t.field_77352_x, this.func_70694_bm());
      int var4 = EnchantmentHelper.func_77506_a(Enchantment.field_77344_u.field_77352_x, this.func_70694_bm());
      if(var3 > 0) {
         var2.func_70239_b(var2.func_70242_d() + (double)var3 * 0.5D + 0.5D);
      }

      if(var4 > 0) {
         var2.func_70240_a(var4);
      }
