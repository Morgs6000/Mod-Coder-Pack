...
public class NetServerHandler extends NetHandler {
   ...
   public void func_72565_c(String p_72565_1_) {
      if(!this.field_72576_c) {
         ...
         this.field_72573_d.func_71203_ab().func_72384_a(new Packet3Chat("\u00a7e" + this.field_72574_e.field_71092_bJ + " left the game."));
         ...
         if(this.field_72587_r) {
            ...
            if(p_72498_1_.field_73546_h) {
               ...
               if(!this.field_72574_e.func_70608_bn() && (var13 > 1.65D || var13 < 0.1D)) {
                  ...
                  field_72577_a.warning(this.field_72574_e.field_71092_bJ + " had an illegal stance: " + var13);
                  return;
               }
            ...
            if(var25 > 100.0D && (!this.field_72573_d.func_71264_H() || !this.field_72573_d.func_71214_G().equals(this.field_72574_e.field_71092_bJ))) {
               field_72577_a.warning(this.field_72574_e.field_71092_bJ + " moved too quickly! " + var13 + "," + var15 + "," + var17 + " (" + var19 + ", " + var21 + ", " + var23 + ")");
   ...
   public void func_72510_a(Packet14BlockDig p_72510_1_) {
      ...
      if(p_72510_1_.field_73342_e == 4) {
         ...
         int var3 = this.field_72573_d.func_82357_ak();
         boolean var4 = var2.field_73011_w.field_76574_g != 0 || this.field_72573_d.func_71203_ab().func_72376_i().isEmpty() || this.field_72573_d.func_71203_ab().func_72353_e(this.field_72574_e.field_71092_bJ) || var3 <= 0 || this.field_72573_d.func_71264_H();
         boolean var5 = false;
         ...
         int var6 = p_72510_1_.field_73345_a;
         int var7 = p_72510_1_.field_73343_b;
         int var8 = p_72510_1_.field_73344_c;
         if(var5) {
            double var9 = this.field_72574_e.field_70165_t - ((double)var6 + 0.5D);
            double var11 = this.field_72574_e.field_70163_u - ((double)var7 + 0.5D) + 1.5D;
            ...
            if(var7 >= this.field_72573_d.func_71207_Z()) {
               return;
            }
         }

         ChunkCoordinates var17 = var2.func_72861_E();
         int var10 = MathHelper.func_76130_a(var6 - var17.field_71574_a);
         int var18 = MathHelper.func_76130_a(var8 - var17.field_71573_c);
         if(var10 > var18) {
            var18 = var10;
         }
         ...
         if(p_72510_1_.field_73342_e == 0) {
            if(var18 <= var3 && !var4) {
               ...
               this.field_72574_e.field_71134_c.func_73074_a(var6, var7, var8, p_72510_1_.field_73341_d);
            }
         } else if(p_72510_1_.field_73342_e == 2) {
            this.field_72574_e.field_71134_c.func_73082_a(var6, var7, var8);
            if(var2.func_72798_a(var6, var7, var8) != 0) {
               this.field_72574_e.field_71135_a.func_72567_b(new Packet53BlockChange(var6, var7, var8, var2));
            }
         } else if(p_72510_1_.field_73342_e == 1) {
            this.field_72574_e.field_71134_c.func_73073_c(var6, var7, var8);
            if(var2.func_72798_a(var6, var7, var8) != 0) {
               this.field_72574_e.field_71135_a.func_72567_b(new Packet53BlockChange(var6, var7, var8, var2));
            }
         }
   ...
   public void func_72472_a(Packet15Place p_72472_1_) {
      ...
      int var9 = this.field_72573_d.func_82357_ak();
      boolean var10 = var2.field_73011_w.field_76574_g != 0 || this.field_72573_d.func_71203_ab().func_72376_i().isEmpty() || this.field_72573_d.func_71203_ab().func_72353_e(this.field_72574_e.field_71092_bJ) || var9 <= 0 || this.field_72573_d.func_71264_H();
      if(p_72472_1_.func_73401_h() == 255) {
         ...
         ChunkCoordinates var11 = var2.func_72861_E();
         int var12 = MathHelper.func_76130_a(var5 - var11.field_71574_a);
         int var13 = MathHelper.func_76130_a(var7 - var11.field_71573_c);
         if(var12 > var13) {
            var13 = var12;
         }
      ...
      if(var3 == null || var3.func_77988_m() == 0) {
         ...
         Slot var14 = this.field_72574_e.field_71070_bA.func_75147_a(this.field_72574_e.field_71071_by, this.field_72574_e.field_71071_by.field_70461_c);
         ...
         if(!ItemStack.func_77989_b(this.field_72574_e.field_71071_by.func_70448_g(), p_72472_1_.func_73405_i())) {
            this.func_72567_b(new Packet103SetSlot(this.field_72574_e.field_71070_bA.field_75152_c, var14.field_75222_d, this.field_72574_e.field_71071_by.func_70448_g()));
         }
      }
