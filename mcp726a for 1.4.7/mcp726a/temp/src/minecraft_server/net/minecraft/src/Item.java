...
import net.minecraft.src.ItemFirework;
import net.minecraft.src.ItemFireworkCharge;
...
import net.minecraft.src.ItemHangingEntity;
...
public class Item {
   ...
   public static Item field_77671_F = (new ItemSoup(26, 6)).func_77652_b(8, 4).func_77655_b("mushroomStew");
   ...
   public static Item field_77780_as = (new ItemHangingEntity(65, EntityPainting.class)).func_77652_b(10, 1).func_77655_b("painting");
   ...
   public static Item field_77760_aL = (new ItemBook(84)).func_77652_b(11, 3).func_77655_b("book").func_77637_a(CreativeTabs.field_78026_f);
   ...
   public static Item field_82802_bI = (new ItemHangingEntity(133, EntityItemFrame.class)).func_77652_b(14, 12).func_77655_b("frame");
   public static Item field_82796_bJ = (new ItemReed(134, Block.field_82516_cf)).func_77652_b(13, 11).func_77655_b("flowerPot").func_77637_a(CreativeTabs.field_78031_c);
   public static Item field_82797_bK = (new ItemSeedFood(135, 4, 0.6F, Block.field_82513_cg.field_71990_ca, Block.field_72050_aA.field_71990_ca)).func_77652_b(8, 7).func_77655_b("carrots");
   public static Item field_82794_bL = (new ItemSeedFood(136, 1, 0.3F, Block.field_82514_ch.field_71990_ca, Block.field_72050_aA.field_71990_ca)).func_77652_b(7, 7).func_77655_b("potato");
   public static Item field_82795_bM = (new ItemFood(137, 6, 0.6F, false)).func_77652_b(6, 7).func_77655_b("potatoBaked");
   public static Item field_82800_bN = (new ItemFood(138, 2, 0.3F, false)).func_77844_a(Potion.field_76436_u.field_76415_H, 5, 0, 0.6F).func_77652_b(6, 8).func_77655_b("potatoPoisonous");
   public static ItemEmptyMap field_82801_bO = (ItemEmptyMap)(new ItemEmptyMap(139)).func_77652_b(13, 12).func_77655_b("emptyMap");
   public static Item field_82798_bP = (new ItemFood(140, 6, 1.2F, false)).func_77652_b(6, 9).func_77655_b("carrotGolden").func_77631_c(PotionHelper.field_82818_l);
   public static Item field_82799_bQ = (new ItemSkull(141)).func_77655_b("skull");
   public static Item field_82793_bR = (new ItemCarrotOnAStick(142)).func_77652_b(6, 6).func_77655_b("carrotOnAStick");
   public static Item field_82792_bS = (new ItemSimpleFoiled(143)).func_77652_b(9, 11).func_77655_b("netherStar").func_77637_a(CreativeTabs.field_78035_l);
   public static Item field_82791_bT = (new ItemFood(144, 8, 0.3F, false)).func_77652_b(8, 9).func_77655_b("pumpkinPie").func_77637_a(CreativeTabs.field_78039_h);
   public static Item field_92104_bU = (new ItemFirework(145)).func_77652_b(9, 12).func_77655_b("fireworks");
   public static Item field_92106_bV = (new ItemFireworkCharge(146)).func_77652_b(10, 12).func_77655_b("fireworksCharge").func_77637_a(CreativeTabs.field_78026_f);
   public static ItemEnchantedBook field_92105_bW = (ItemEnchantedBook)(new ItemEnchantedBook(147)).func_77652_b(15, 12).func_77625_d(1).func_77655_b("enchantedBook");
   ...
   public static Item field_85180_cf = (new ItemRecord(2011, "wait")).func_77652_b(11, 15).func_77655_b("record");
