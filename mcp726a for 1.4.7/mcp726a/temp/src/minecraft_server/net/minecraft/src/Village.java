...
public class Village {
   ...
   public void func_82689_b(NBTTagCompound p_82689_1_) {
      ...
      Iterator var9 = this.field_82693_j.keySet().iterator();

      while(var9.hasNext()) {
         String var7 = (String)var9.next();
         NBTTagCompound var6 = new NBTTagCompound(var7);
         var6.func_74778_a("Name", var7);
         var6.func_74768_a("S", ((Integer)this.field_82693_j.get(var7)).intValue());
         var8.func_74742_a(var6);
      }

      p_82689_1_.func_74782_a("Players", var8);
   }
