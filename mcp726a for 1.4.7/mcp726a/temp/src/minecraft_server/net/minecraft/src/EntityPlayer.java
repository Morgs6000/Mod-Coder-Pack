...
public abstract class EntityPlayer extends EntityLiving implements ICommandSender {
   ...
   protected int func_70672_c(DamageSource p_70672_1_, int p_70672_2_) {
      ...
      if(var3 <= 0) {
         ...
         int var4 = EnchantmentHelper.func_77508_a(this.field_71071_by.field_70460_b, p_70672_1_);
         if(var4 > 20) {
            var4 = 20;
         }
      ...
      if(p_71059_1_.func_70075_an()) {
         if(!p_71059_1_.func_85031_j(this)) {
            ...
            if(var2 > 0 || var4 > 0) {
               ...
               if(var9 != null && p_71059_1_ instanceof EntityLiving) {
                  var9.func_77961_a((EntityLiving)p_71059_1_, this);
