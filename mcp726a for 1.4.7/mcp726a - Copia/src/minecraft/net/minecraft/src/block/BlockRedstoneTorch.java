...
public class BlockRedstoneTorch extends BlockTorch {
    ...
    public int getBlockTextureFromSideAndMetadata(int par1, int par2) {
        return par1 == 1 ? Block.redstoneWire.getBlockTextureFromSideAndMetadata(par1, par2)
                : super.getBlockTextureFromSideAndMetadata(par1, par2);
    }
    ...
    public boolean isProvidingWeakPower(IBlockAccess par1IBlockAccess, int par2, int par3, int par4, int par5) {
        if (!this.torchActive) {
            ...
            return var6 == 5 && par5 == 1 ? false
                    : (var6 == 3 && par5 == 3 ? false
                            : (var6 == 4 && par5 == 2 ? false
                                    : (var6 == 1 && par5 == 5 ? false : var6 != 2 || par5 != 4)));
        }
    }
    ...
    private boolean isIndirectlyPowered(World par1World, int par2, int par3, int par4) {
        ...
        return var5 == 5 && par1World.isBlockIndirectlyProvidingPowerTo(par2, par3 - 1, par4, 0) ? true
                : (var5 == 3 && par1World.isBlockIndirectlyProvidingPowerTo(par2, par3, par4 - 1, 2) ? true
                        : (var5 == 4 && par1World.isBlockIndirectlyProvidingPowerTo(par2, par3, par4 + 1, 3) ? true
                                : (var5 == 1 && par1World.isBlockIndirectlyProvidingPowerTo(par2 - 1, par3, par4, 4)
                                        ? true
                                        : var5 == 2 && par1World.isBlockIndirectlyProvidingPowerTo(par2 + 1, par3, par4,
                                                5))));
    }
    ...
    public void updateTick(World par1World, int par2, int par3, int par4, Random par5Random) {
        ...
        if (this.torchActive) {
            if (var6) {
                par1World.setBlockAndMetadataWithNotify(par2, par3, par4, Block.torchRedstoneIdle.blockID,
            ...
            par1World.setBlockAndMetadataWithNotify(par2, par3, par4, Block.torchRedstoneActive.blockID,
                    par1World.getBlockMetadata(par2, par3, par4));
        }
    }
