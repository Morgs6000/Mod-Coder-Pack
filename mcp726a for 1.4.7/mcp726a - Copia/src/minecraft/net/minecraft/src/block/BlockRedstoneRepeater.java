...
public class BlockRedstoneRepeater extends BlockDirectional {
    ...
    public void updateTick(World par1World, int par2, int par3, int par4, Random par5Random) {
        ...
        if (!var7) {
            ...
            if (this.isRepeaterPowered && !var8) {
                ...
                if (!var8) {
                    int var9 = (var6 & 12) >> 2;
                    par1World.scheduleBlockUpdate(par2, par3, par4, Block.redstoneRepeaterActive.blockID,
                            repeaterState[var9] * 2);
                }
            }
        }
    }
    ...
    public boolean isProvidingWeakPower(IBlockAccess par1IBlockAccess, int par2, int par3, int par4, int par5) {
        if (!this.isRepeaterPowered) {
            ...
            return var6 == 0 && par5 == 3 ? true
                    : (var6 == 1 && par5 == 4 ? true : (var6 == 2 && par5 == 2 ? true : var6 == 3 && par5 == 5));
        }
    }
    ...
    private boolean ignoreTick(World par1World, int par2, int par3, int par4, int par5) {
        ...
        switch (var6) {
            case 0:
                return par1World.isBlockIndirectlyProvidingPowerTo(par2, par3, par4 + 1, 3)
                        || par1World.getBlockId(par2, par3, par4 + 1) == Block.redstoneWire.blockID
                                && par1World.getBlockMetadata(par2, par3, par4 + 1) > 0;

            case 1:
                return par1World.isBlockIndirectlyProvidingPowerTo(par2 - 1, par3, par4, 4)
                        || par1World.getBlockId(par2 - 1, par3, par4) == Block.redstoneWire.blockID
                                && par1World.getBlockMetadata(par2 - 1, par3, par4) > 0;

            case 2:
                return par1World.isBlockIndirectlyProvidingPowerTo(par2, par3, par4 - 1, 2)
                        || par1World.getBlockId(par2, par3, par4 - 1) == Block.redstoneWire.blockID
                                && par1World.getBlockMetadata(par2, par3, par4 - 1) > 0;

            case 3:
                return par1World.isBlockIndirectlyProvidingPowerTo(par2 + 1, par3, par4, 5)
                        || par1World.getBlockId(par2 + 1, par3, par4) == Block.redstoneWire.blockID
                                && par1World.getBlockMetadata(par2 + 1, par3, par4) > 0;
    ...
    public boolean func_82523_e(IBlockAccess par1IBlockAccess, int par2, int par3, int par4, int par5) {
        ...
        switch (var6) {
            case 0:
            case 2:
                return par1IBlockAccess.isBlockProvidingPowerTo(par2 - 1, par3, par4, 4)
                        && func_82524_c(par1IBlockAccess.getBlockId(par2 - 1, par3, par4))
                        || par1IBlockAccess.isBlockProvidingPowerTo(par2 + 1, par3, par4, 5)
                                && func_82524_c(par1IBlockAccess.getBlockId(par2 + 1, par3, par4));

            case 1:
            case 3:
                return par1IBlockAccess.isBlockProvidingPowerTo(par2, par3, par4 + 1, 3)
                        && func_82524_c(par1IBlockAccess.getBlockId(par2, par3, par4 + 1))
                        || par1IBlockAccess.isBlockProvidingPowerTo(par2, par3, par4 - 1, 2)
                                && func_82524_c(par1IBlockAccess.getBlockId(par2, par3, par4 - 1));
    ...
    public void onBlockPlacedBy(World par1World, int par2, int par3, int par4, EntityLiving par5EntityLiving) {
        int var6 = ((MathHelper.floor_double((double) (par5EntityLiving.rotationYaw * 4.0F / 360.0F) + 0.5D) & 3) + 2)
                % 4;
