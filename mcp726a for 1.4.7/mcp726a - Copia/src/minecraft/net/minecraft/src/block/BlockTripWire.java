...
public class BlockTripWire extends Block {
    ...
    private void updateTripWireState(World par1World, int par2, int par3, int par4) {
        ...
        List var8 = par1World.getEntitiesWithinAABBExcludingEntity((Entity) null,
                AxisAlignedBB.getAABBPool().addOrModifyAABBInPool((double) par2 + this.minX, (double) par3 + this.minY,
    ...
    public static boolean func_72148_a(IBlockAccess par0IBlockAccess, int par1, int par2, int par3, int par4,
            int par5) {
