...
public class BlockFence extends Block {
    ...
    public AxisAlignedBB getCollisionBoundingBoxFromPool(World par1World, int par2, int par3, int par4) {
        ...
        return AxisAlignedBB.getAABBPool().addOrModifyAABBInPool((double) ((float) par2 + var9), (double) par3,
                (double) ((float) par4 + var11), (double) ((float) par2 + var10), (double) ((float) par3 + 1.5F),
