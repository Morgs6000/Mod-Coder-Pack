...
public abstract class BlockFluid extends Block {
     ...
     * >=8) to their effective source block
     * value of zero.
     */
    ...
    public void randomDisplayTick(World par1World, int par2, int par3, int par4, Random par5Random) {
        ...
        if (this.blockMaterial == Material.water) {
            if (par5Random.nextInt(10) == 0) {
                ...
                if (var6 <= 0 || var6 >= 8) {
                    par1World.spawnParticle("suspended", (double) ((float) par2 + par5Random.nextFloat()),
        ...
        if (this.blockMaterial == Material.water && par5Random.nextInt(64) == 0) {
            ...
            if (var6 > 0 && var6 < 8) {
                par1World.playSound((double) ((float) par2 + 0.5F), (double) ((float) par3 + 0.5F),
                        (double) ((float) par4 + 0.5F), "liquid.water", par5Random.nextFloat() * 0.25F + 0.75F,
        ...
        if (this.blockMaterial == Material.lava && par1World.getBlockMaterial(par2, par3 + 1, par4) == Material.air
            ...
            if (par5Random.nextInt(200) == 0) {
                par1World.playSound((double) par2, (double) par3, (double) par4, "liquid.lava",
                        0.2F + par5Random.nextFloat() * 0.2F, 0.9F + par5Random.nextFloat() * 0.15F, false);
            }
        }
     ...
     * block.
     */
    public static double getFlowDirection(IBlockAccess par0IBlockAccess, int par1, int par2, int par3,
        ...
        return var5.xCoord == 0.0D && var5.zCoord == 0.0D ? -1000.0D
