                ...
                if (var10 >= 2 && var10 <= 5 && (var9 & 1 << var11) == 0) {
                    ...
                    if (var12 != 0 && Block.blocksList[var12] != null) {
                        ...
                        if ((var9 & 1 << var13) != 0 && this.canBePlacedOn(
                            ...
                            par1World.setBlockAndMetadataWithNotify(par2 + Direction.offsetX[var11], par3,
                                    par4 + Direction.offsetZ[var11], this.blockID, 1 << var13);
                            ...
                            par1World.setBlockAndMetadataWithNotify(par2 + Direction.offsetX[var11], par3,
                                    par4 + Direction.offsetZ[var11], this.blockID, 1 << var14);
                            ...
                            par1World.setBlockAndMetadataWithNotify(
                                    par2 + Direction.offsetX[var11] + Direction.offsetX[var13], par3,
                            ...
                            par1World.setBlockAndMetadataWithNotify(
                                    par2 + Direction.offsetX[var11] + Direction.offsetX[var14], par3,
                                ...
                                par4 + Direction.offsetZ[var11]))) {
                            par1World.setBlockAndMetadataWithNotify(par2 + Direction.offsetX[var11], par3,
                                    par4 + Direction.offsetZ[var11], this.blockID, 0);
                        }
                    }
                } else if (par3 > 1) {
