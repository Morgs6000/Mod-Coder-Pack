...
public class BlockPumpkin extends BlockDirectional {
    ...
    public int getBlockTextureFromSideAndMetadata(int par1, int par2) {
        if (par1 == 1) {
            ...
            return par2 == 2 && par1 == 2 ? var3
                    : (par2 == 3 && par1 == 5 ? var3
                            : (par2 == 0 && par1 == 3 ? var3
                                    : (par2 == 1 && par1 == 4 ? var3 : this.blockIndexInTexture + 16)));
        }
    }
    ...
    public int getBlockTextureFromSide(int par1) {
        return par1 == 1 ? this.blockIndexInTexture
                : (par1 == 0 ? this.blockIndexInTexture
                        : (par1 == 3 ? this.blockIndexInTexture + 1 + 16 : this.blockIndexInTexture + 16));
    }
    ...
    public void onBlockAdded(World par1World, int par2, int par3, int par4) {
        ...
        if (par1World.getBlockId(par2, par3 - 1, par4) == Block.blockSnow.blockID
            ...
            boolean var5 = par1World.getBlockId(par2 - 1, par3 - 1, par4) == Block.blockSteel.blockID
                    && par1World.getBlockId(par2 + 1, par3 - 1, par4) == Block.blockSteel.blockID;
            boolean var6 = par1World.getBlockId(par2, par3 - 1, par4 - 1) == Block.blockSteel.blockID
