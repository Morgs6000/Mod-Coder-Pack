...
public class BlockFlowing extends BlockFluid {
     ...
     * Only source blocks of the same
     ...
     * array index corresponds to one of
     ...
     * into the block at the coordinates and
     ...
     * determine the path of least resistance, this method returns the lowest
     * possible flow cost for the direction of
     ...
     * each direction's calculated flow
     * cost. Each array index corresponds to one of the four cardinal directions. A
     * value of true indicates the
     ...
     * currentSmallestFlowDecay) - Looks up the flow decay at
     * the coordinates given and returns the smaller of this value or the provided
     * currentSmallestFlowDecay. If one
     * value is valid and the other isn't, the valid value will be returned. Valid
     * values are >= 0. Flow decay is the
