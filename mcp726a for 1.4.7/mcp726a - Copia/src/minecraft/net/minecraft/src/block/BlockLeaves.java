...
public class BlockLeaves extends BlockLeavesBase {
    /**
     * The base index in terrain.png corresponding to the fancy version of the leaf
     * texture. This is stored so we can
     * switch the displayed version between fancy and fast graphics (fast is this
     * index + 1).
     */
    ...
    public int getBlockTextureFromSideAndMetadata(int par1, int par2) {
        return (par2 & 3) == 1 ? this.blockIndexInTexture + 80
                : ((par2 & 3) == 3 ? this.blockIndexInTexture + 144 : this.blockIndexInTexture);
    }
