...
public class BlockFenceGate extends BlockDirectional {
    ...
    public AxisAlignedBB getCollisionBoundingBoxFromPool(World par1World, int par2, int par3, int par4) {
        ...
        return isFenceGateOpen(var5) ? null
                : (var5 != 2 && var5 != 0
                        ? AxisAlignedBB.getAABBPool().addOrModifyAABBInPool((double) ((float) par2 + 0.375F),
                                (double) par3, (double) par4, (double) ((float) par2 + 0.625F),
                                (double) ((float) par3 + 1.5F), (double) (par4 + 1))
                        : AxisAlignedBB.getAABBPool().addOrModifyAABBInPool((double) par2, (double) par3,
