...
public class BlockRail extends Block {
     ...
     * block (current is rail, powered or
     * detector).
     */
    ...
    public void onNeighborBlockChange(World par1World, int par2, int par3, int par4, int par5) {
        if (!par1World.isRemote) {
            ...
            if (var8) {
                ...
                var9 = var9 || this.isNeighborRailPowered(par1World, par2, par3, par4, var6, true, 0)
            ...
            } else if (par5 > 0 && Block.blocksList[par5].canProvidePower() && !this.isPowered
                    && RailLogic.getAdjacentTrackCount(new RailLogic(this, par1World, par2, par3, par4)) == 3) {
    ...
    private void refreshTrackShape(World par1World, int par2, int par3, int par4, boolean par5) {
        if (!par1World.isRemote) {
            (new RailLogic(this, par1World, par2, par3, par4))
                    .refreshTrackShape(par1World.isBlockIndirectlyGettingPowered(par2, par3, par4), par5);
        }
    }
     ...
     */
    private boolean isNeighborRailPowered(World par1World, int par2, int par3, int par4, int par5, boolean par6,
            int par7) {
        if (par7 >= 8) {
            return false;
        } else {
            ...
            return this.isRailPassingPower(par1World, par2, par3, par4, par6, par7, var8) ? true
                    : var9 && this.isRailPassingPower(par1World, par2, par3 - 1, par4, par6, par7, var8);
        }
    }
     ...
     */
    private boolean isRailPassingPower(World par1World, int par2, int par3, int par4, boolean par5, int par6,
            int par7) {
