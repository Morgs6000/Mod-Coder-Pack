...
public class BlockFire extends Block {
     ...
     * more likely a block type will catch
     * fires
     */
     ...
     * it will catch. The larger
     * chanceToEncourageFire the faster it will burn and spread to other blocks.
     * Args: blockID, chanceToEncourageFire,
     * abilityToCatchFire
     */
                                ...
                                if (var10 != par2 || var12 != par3 || var11 != par4) {
                                    ...
                                    if (var14 > 0) {
                                        ...
                                        if (var15 > 0 && par5Random.nextInt(var13) <= var15
                                            ...
                                            par1World.setBlockAndMetadataWithNotify(var10, var12, var11, this.blockID,
                                                    var16);
                                        }
                                    }
                                }
     ...
     * current number passed in it will return its number instead of the passed in
     * one. Args: world, x, y, z,
        ...
        if (par1World.provider.dimensionId > 0 || par1World.getBlockId(par2, par3 - 1, par4) != Block.obsidian.blockID
            ...
            if (!par1World.doesBlockHaveSolidTopSurface(par2, par3 - 1, par4)
                ...
                par1World.scheduleBlockUpdate(par2, par3, par4, this.blockID,
                        this.tickRate() + par1World.rand.nextInt(10));
            }
        }
    }
    ...
    public void randomDisplayTick(World par1World, int par2, int par3, int par4, Random par5Random) {
        if (par5Random.nextInt(24) == 0) {
            par1World.playSound((double) ((float) par2 + 0.5F), (double) ((float) par3 + 0.5F),
                    (double) ((float) par4 + 0.5F), "fire.fire", 1.0F + par5Random.nextFloat(),
        ...
        if (!par1World.doesBlockHaveSolidTopSurface(par2, par3 - 1, par4)
            ...
            if (Block.fire.canBlockCatchFire(par1World, par2 - 1, par3, par4)) {
                for (var6 = 0; var6 < 2; ++var6) {
                    ...
                    par1World.spawnParticle("largesmoke", (double) var7, (double) var8, (double) var9, 0.0D, 0.0D,
                            0.0D);
                }
            }
