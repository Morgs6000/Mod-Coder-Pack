...
public class ItemRenderer {
    ...
    public ItemRenderer(Minecraft par1Minecraft) {
        ...
        this.mapItemRenderer = new MapItemRenderer(par1Minecraft.fontRenderer, par1Minecraft.gameSettings,
    ...
    public static void renderItemIn2D(Tessellator par0Tessellator, float par1, float par2, float par3, float par4,
        ...
        for (var7 = 0; var7 < 16; ++var7) {
            ...
            par0Tessellator.addVertexWithUV((double) var6, (double) var10, (double) (0.0F - par5), (double) par3,
                    (double) var9);
    ...
    public void renderItemInFirstPerson(float par1) {
        ...
        var6 = this.mc.theWorld.getLightBrightness(MathHelper.floor_double(var3.posX),
                MathHelper.floor_double(var3.posY), MathHelper.floor_double(var3.posZ));
        var6 = 1.0F;
        int var18 = this.mc.theWorld.getLightBrightnessForSkyBlocks(MathHelper.floor_double(var3.posX),
        ...
        if (var17 != null && var17.itemID == Item.map.itemID) {
            ...
            GL11.glTranslatef(-var10 * 0.4F,
                    MathHelper.sin(MathHelper.sqrt_float(var19) * (float) Math.PI * 2.0F) * 0.2F, -var21 * 0.2F);
            ...
            GL11.glBindTexture(GL11.GL_TEXTURE_2D, this.mc.renderEngine
                    .getTextureForDownloadableImage(this.mc.thePlayer.skinUrl, this.mc.thePlayer.getTexture()));
            ...
            if (var3.getItemInUseCount() > 0) {
                ...
                if (var20 == EnumAction.eat || var20 == EnumAction.drink) {
                    ...
                    GL11.glTranslatef(0.0F, MathHelper.abs(MathHelper.cos(var21 / 4.0F * (float) Math.PI) * 0.1F)
                            * (float) ((double) var10 > 0.2D ? 1 : 0), 0.0F);
            ...
            var21 = MathHelper.sin(var19 * (float) Math.PI);
            var10 = MathHelper.sin(MathHelper.sqrt_float(var19) * (float) Math.PI);
            GL11.glTranslatef(-var10 * 0.3F,
                    MathHelper.sin(MathHelper.sqrt_float(var19) * (float) Math.PI * 2.0F) * 0.4F, -var21 * 0.4F);
