        ...
        if (!par2EntityPlayer.canPlayerEdit(par4, par5, par6, par7, par1ItemStack)) {
            ...
            if (par1ItemStack.getItemDamage() == 15) {
                ...
                if (var11 == Block.mushroomBrown.blockID || var11 == Block.mushroomRed.blockID) {
                    if (!par3World.isRemote && ((BlockMushroom) Block.blocksList[var11]).fertilizeMushroom(par3World,
                ...
                if (var11 == Block.cocoaPlant.blockID) {
                    if (!par3World.isRemote) {
                        par3World.setBlockMetadataWithNotify(par4, par5, par6,
                                8 | BlockDirectional.getDirection(par3World.getBlockMetadata(par4, par5, par6)));
                        --par1ItemStack.stackSize;
                    }
                    ...
                    if (!par3World.isRemote) {
                        ...
                        for (var12 = 0; var12 < 128; ++var12) {
                            ...
                            for (int var16 = 0; var16 < var12 / 16; ++var16) {
                                ...
                                if (par3World.getBlockId(var13, var14 - 1, var15) != Block.grass.blockID
                                        || par3World.isBlockNormalCube(var13, var14, var15)) {
                                    continue label133;
                                }
                            }
                            ...
                            if (par3World.getBlockId(var13, var14, var15) == 0) {
                                if (itemRand.nextInt(10) != 0) {
                                    if (Block.tallGrass.canBlockStay(par3World, var13, var14, var15)) {
                                        par3World.setBlockAndMetadataWithNotify(var13, var14, var15,
                ...
                if (var11 == Block.wood.blockID && BlockLog.limitToValidMetadata(var12) == 3) {
                    ...
                    if (par3World.isAirBlock(par4, par5, par6)) {
                        var13 = Block.blocksList[Block.cocoaPlant.blockID].onBlockPlaced(par3World, par4, par5, par6,
                                par7, par8, par9, par10, 0);
