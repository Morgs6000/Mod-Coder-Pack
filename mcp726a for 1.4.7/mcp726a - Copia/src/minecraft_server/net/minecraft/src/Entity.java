        ...
        else
        {
            ...
            if (this.canTriggerWalking() && !var20 && this.ridingEntity == null)
            {
                ...
                if (this.field_82151_R > (float)this.nextStepDistance && var32 > 0)
                {
                    ...
                    if (this.isInWater())
                    {
                        float var40 = MathHelper.sqrt_double(this.motionX * this.motionX * 0.20000000298023224D + this.motionY * this.motionY + this.motionZ * this.motionZ * 0.20000000298023224D) * 0.35F;
                        ...
                        this.playSound("liquid.swim", var40, 1.0F + (this.rand.nextFloat() - this.rand.nextFloat()) * 0.4F);
                    }
