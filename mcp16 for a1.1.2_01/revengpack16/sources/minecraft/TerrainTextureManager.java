...
public class TerrainTextureManager
{
    ...
    public TerrainTextureManager()
    {
        ...
        for(int i = 0; i < 256; i++)
        {
            ...
            {
                field_1182_g[i * 3 + 0] = Block.allBlocks[i].func_218_a(1);
                field_1182_g[i * 3 + 1] = Block.allBlocks[i].func_218_a(2);
                field_1182_g[i * 3 + 2] = Block.allBlocks[i].func_218_a(3);
            }
        }
        ...
        for(int i1 = l - 1; i1 >= j; i1--)
        {
            for(int j1 = k - 1; j1 >= i; j1--)
            {
                ...
                for(int j2 = 0; j2 < 128; j2++)
                {
                    ...
                    Block block = Block.allBlocks[world.func_600_a(j1, j2, i1)];
                    if(block == null)
                    {
                        flag = false;
                        continue;
                    ...
                    if(block.material == Material.water)
                    {
                        ...
                        if(l2 != 0 && Block.allBlocks[l2].material == Material.water)
                        {
                            continue;
                        }
