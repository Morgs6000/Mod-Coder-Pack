...
class MinecartTrackLogic
{
    ...
    public MinecartTrackLogic(BlockMinecartTrack blockminecarttrack, World world, int i, int j, int k)
    {
        ...
        field_1164_d = j;
        field_1163_e = k;
        field_1162_f = world.func_602_e(i, j, k);
        func_789_a();
    }
    ...
    {
        if(field_1159_b.func_600_a(i, j, k) == field_1160_a.blockID)
        {
            return true;
        }
        if(field_1159_b.func_600_a(i, j + 1, k) == field_1160_a.blockID)
        {
            return true;
        }
        return field_1159_b.func_600_a(i, j - 1, k) == field_1160_a.blockID;
    }

    private MinecartTrackLogic func_795_a(ChunkPosition chunkposition)
    {
        if(field_1159_b.func_600_a(chunkposition.field_1111_a, chunkposition.field_1110_b, chunkposition.field_1112_c) == field_1160_a.blockID)
        {
            return new MinecartTrackLogic(field_1160_a, field_1159_b, chunkposition.field_1111_a, chunkposition.field_1110_b, chunkposition.field_1112_c);
        }
        if(field_1159_b.func_600_a(chunkposition.field_1111_a, chunkposition.field_1110_b + 1, chunkposition.field_1112_c) == field_1160_a.blockID)
        {
            return new MinecartTrackLogic(field_1160_a, field_1159_b, chunkposition.field_1111_a, chunkposition.field_1110_b + 1, chunkposition.field_1112_c);
        }
        if(field_1159_b.func_600_a(chunkposition.field_1111_a, chunkposition.field_1110_b - 1, chunkposition.field_1112_c) == field_1160_a.blockID)
        {
            return new MinecartTrackLogic(field_1160_a, field_1159_b, chunkposition.field_1111_a, chunkposition.field_1110_b - 1, chunkposition.field_1112_c);
    ...
    private boolean func_793_b(MinecartTrackLogic minecarttracklogic)
    {
        for(int i = 0; i < field_1161_g.size(); i++)
        {
            ...
            if(chunkposition.field_1111_a == minecarttracklogic.field_1165_c && chunkposition.field_1112_c == minecarttracklogic.field_1163_e)
            {
                return true;
            }
        }
    ...
    private boolean func_787_c(MinecartTrackLogic minecarttracklogic)
    {
        ...
        return minecarttracklogic.field_1164_d != field_1164_d || chunkposition.field_1110_b != field_1164_d ? true : true;
    }
    ...
    private void func_788_d(MinecartTrackLogic minecarttracklogic)
    {
        ...
        if(byte0 == 0)
        {
            if(field_1159_b.func_600_a(field_1165_c, field_1164_d + 1, field_1163_e - 1) == field_1160_a.blockID)
            {
                byte0 = 4;
            }
            if(field_1159_b.func_600_a(field_1165_c, field_1164_d + 1, field_1163_e + 1) == field_1160_a.blockID)
        ...
        if(byte0 == 1)
        {
            if(field_1159_b.func_600_a(field_1165_c + 1, field_1164_d + 1, field_1163_e) == field_1160_a.blockID)
            {
                byte0 = 2;
            }
            if(field_1159_b.func_600_a(field_1165_c - 1, field_1164_d + 1, field_1163_e) == field_1160_a.blockID)
