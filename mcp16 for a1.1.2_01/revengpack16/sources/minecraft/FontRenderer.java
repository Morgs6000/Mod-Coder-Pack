...
public class FontRenderer
{
    ...
    public FontRenderer(GameSettings gamesettings, String s, RenderEngine renderengine)
    {
        ...
        field_1308_a = 0;
        field_1309_d = GLAllocation.func_1125_c(1024);
        ...
        field_1310_c = GLAllocation.func_1124_a(288);
        ...
        for(int i1 = 0; i1 < 256; i1++)
        {
            ...
            float f1 = 0.0F;
            float f2 = 0.0F;
            tessellator.func_983_a(0.0D, 0.0F + f, 0.0D, (float)l1 / 128F + f1, ((float)k2 + f) / 128F + f2);
            tessellator.func_983_a(0.0F + f, 0.0F + f, 0.0D, ((float)l1 + f) / 128F + f1, ((float)k2 + f) / 128F + f2);
            tessellator.func_983_a(0.0F + f, 0.0D, 0.0D, ((float)l1 + f) / 128F + f1, (float)k2 / 128F + f2);
            tessellator.func_983_a(0.0D, 0.0D, 0.0D, (float)l1 / 128F + f1, (float)k2 / 128F + f2);
