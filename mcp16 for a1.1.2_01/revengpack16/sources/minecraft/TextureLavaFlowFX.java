...
public class TextureLavaFlowFX extends TextureFX
{
    ...
    {
        super(Block.lavaStill.field_378_bb + 1);
    ...
    public void func_783_a()
    {
        ...
        for(int i = 0; i < 16; i++)
        {
            ...
            {
                float f = 0.0F;
                int l = (int)(MathHelper.func_1106_a(((float)j * 3.141593F * 2.0F) / 16F) * 1.2F);
                int i1 = (int)(MathHelper.func_1106_a(((float)i * 3.141593F * 2.0F) / 16F) * 1.2F);
