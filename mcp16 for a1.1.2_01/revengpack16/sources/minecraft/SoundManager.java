...
public class SoundManager
{
    ...
    private void func_339_d()
    {
        try
        {
            float f = field_586_f.soundVolume;
            float f1 = field_586_f.musicVolume;
            field_586_f.soundVolume = 0.0F;
            field_586_f.musicVolume = 0.0F;
            ...
            field_586_f.soundVolume = f;
            field_586_f.musicVolume = f1;
            field_586_f.func_1041_b();
        }
    ...
    {
        if(!field_585_g && (field_586_f.soundVolume != 0.0F || field_586_f.musicVolume != 0.0F))
        {
            func_339_d();
        }
        if(field_586_f.musicVolume == 0.0F)
        {
            field_591_a.stop("BgMusic");
        } else
        {
            field_591_a.setVolume("BgMusic", field_586_f.musicVolume);
        }
    }
    ...
    {
        if(!field_585_g || field_586_f.musicVolume == 0.0F)
        {
            return;
        }
    ...
    {
        if(!field_585_g || field_586_f.soundVolume == 0.0F)
        {
            return;
        }
        ...
        {
            float f1 = entityliving.field_603_as + (entityliving.rotationYaw - entityliving.field_603_as) * f;
    ...
    public void func_331_a(String s, float f, float f1, float f2, float f3, float f4)
    {
        ...
        if(soundpoolentry != null && f3 > 0.0F)
        {
            ...
            field_591_a.setVolume(s1, 0.5F * field_586_f.soundVolume);
            field_591_a.play(s1);
        }
    }
    ...
    public void func_336_b(String s, float f, float f1, float f2, float f3, float f4)
    {
        ...
        if(soundpoolentry != null && f3 > 0.0F)
        {
            ...
            field_591_a.setVolume(s1, f3 * field_586_f.soundVolume);
            field_591_a.play(s1);
        }
    }
    ...
    public void func_337_a(String s, float f, float f1)
    {
        ...
        if(soundpoolentry != null)
        {
            ...
            field_591_a.setVolume(s1, f * field_586_f.soundVolume);
            field_591_a.play(s1);
        }
    }
