...
public class BlockLadder extends Block
{
    ...
    public void func_258_d(World world, int i, int j, int k, int l)
    {
        ...
        if((i1 == 0 || l == 2) && world.func_601_g(i, j, k + 1))
        {
            i1 = 2;
        }
        if((i1 == 0 || l == 3) && world.func_601_g(i, j, k - 1))
        {
            i1 = 3;
        }
        if((i1 == 0 || l == 4) && world.func_601_g(i + 1, j, k))
        {
            i1 = 4;
        }
        if((i1 == 0 || l == 5) && world.func_601_g(i - 1, j, k))
        {
            i1 = 5;
        }
    ...
    public void func_226_a(World world, int i, int j, int k, int l)
    {
        int i1 = world.func_602_e(i, j, k);
        boolean flag = false;
        if(i1 == 2 && world.func_601_g(i, j, k + 1))
        {
            flag = true;
        }
        if(i1 == 3 && world.func_601_g(i, j, k - 1))
        {
            flag = true;
        }
        if(i1 == 4 && world.func_601_g(i + 1, j, k))
        {
            flag = true;
        }
        if(i1 == 5 && world.func_601_g(i - 1, j, k))
        {
            flag = true;
        }
        if(!flag)
