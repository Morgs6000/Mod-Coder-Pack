...
public enum EnumArt
{
    ...
    PigScene      ("Pointer",        64,  64,   0, 192),
    Pointer       ("Pigscene",       64,  64,  64, 192),
...
/*
    static 
    {
        ...
        PigScene = new EnumArt("Pointer", 20, "Pointer", 64, 64, 0, 192);
        Pointer = new EnumArt("Pigscene", 21, "Pigscene", 64, 64, 64, 192);
        ...
        field_1630_D = (new EnumArt[] {
            ...
            PigScene, Pointer, Skeleton, DonkeyKong
        });
    }
*/
}
