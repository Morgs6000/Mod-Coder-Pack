...
public class GuiChat extends GuiScreen
{
    ...
    protected void func_580_a(char c, int i)
    {
        ...
        if(i == 28)
        {
            ...
            if(s.length() > 0)
            {
                mc.field_178_g.func_461_a(field_985_a.trim());
            }
            mc.func_128_a(null);
            return;
        }
    ...
    {
        func_551_a(2, height - 14, width - 2, height - 2, 0x80000000);
        func_547_b(field_947_g, (new StringBuilder()).append("> ").append(field_985_a).append((field_986_h / 6) % 2 != 0 ? "" : "_").toString(), 4, height - 12, 0xe0e0e0);
    }

    protected void func_565_a(int i, int j, int k)
    {
        if(k != 0 || mc.field_164_u.field_933_a == null)
        {
            return;
        }
    	...
    	field_985_a += mc.field_164_u.field_933_a;
        byte byte0 = 100;
