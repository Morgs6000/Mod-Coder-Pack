...
public class IsoListener extends Canvas
    implements KeyListener, MouseListener, MouseMotionListener, Runnable
{
    ...
    public void func_1270_b(String s)
    {
        ...
        field_1790_d = new WorldIso(this, new File(dataFolder, "saves"), s);
    ...
    public void func_1268_a(Graphics2D graphics2d)
    {
        ...
        {
            graphics2d.translate(-(field_1790_d.spawnX + field_1790_d.spawnZ), -(-field_1790_d.spawnX + field_1790_d.spawnZ) + 64);
        }
    ...
    static boolean func_1271_a(IsoListener isolistener)
    {
