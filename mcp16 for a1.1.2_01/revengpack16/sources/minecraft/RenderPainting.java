...
public class RenderPainting extends Render
{
    ...
    {
        int i = MathHelper.func_1108_b(entitypainting.posX);
        int j = MathHelper.func_1108_b(entitypainting.posY + (double)(f1 / 16F));
        int k = MathHelper.func_1108_b(entitypainting.posZ);
        if(entitypainting.field_691_a == 0)
        {
            i = MathHelper.func_1108_b(entitypainting.posX + (double)(f / 16F));
        }
        if(entitypainting.field_691_a == 1)
        {
            k = MathHelper.func_1108_b(entitypainting.posZ - (double)(f / 16F));
        }
