...
public class ModelBiped extends ModelBase
{
    ...
    public ModelBiped(float f, float f1)
    {
        ...
        field_1278_i = false;
        field_1277_j = false;
        field_1286_a = new ModelRenderer(0, 0);
    ...
    public void func_863_a(float f, float f1, float f2, float f3, float f4, float f5)
    {
        ...
        if(field_1244_k > -9990F)
        {
            ...
            f6 *= f6;
            f6 = 1.0F - f6;
            float f7 = MathHelper.func_1106_a(f6 * 3.141593F);
            float f8 = MathHelper.func_1106_a(field_1244_k * 3.141593F) * -(field_1286_a.field_1407_d - 0.7F) * 0.75F;
