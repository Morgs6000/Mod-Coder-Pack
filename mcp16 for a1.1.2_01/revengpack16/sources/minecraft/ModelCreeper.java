...
public class ModelCreeper extends ModelBase
{
    ...
    public ModelCreeper()
    {
        float f = 0.0F;
        int i = 4;
        field_1271_a = new ModelRenderer(0, 0);
