...
public class RenderArrow extends Render
{
            ...
            float f, float f1)
    {
        ...
        GL11.glRotatef((entityarrow.field_603_as + (entityarrow.rotationYaw - entityarrow.field_603_as) * f1) - 90F, 0.0F, 1.0F, 0.0F);
        GL11.glRotatef(entityarrow.field_602_at + (entityarrow.rotationPitch - entityarrow.field_602_at) * f1, 0.0F, 0.0F, 1.0F);
