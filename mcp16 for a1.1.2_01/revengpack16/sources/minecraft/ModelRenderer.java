...
public class ModelRenderer
{
    ...
    {
        field_1401_j = new PositionTexureVertex[8];
        field_1400_k = new TexturedQuad[6];
        float f4 = f + (float)i;
        float f5 = f1 + (float)j;
        float f6 = f2 + (float)k;
        f -= f3;
        ...
        field_1401_j[0] = positiontexurevertex;
        field_1401_j[1] = positiontexurevertex1;
        field_1401_j[2] = positiontexurevertex2;
        field_1401_j[3] = positiontexurevertex3;
        field_1401_j[4] = positiontexurevertex4;
        field_1401_j[5] = positiontexurevertex5;
        field_1401_j[6] = positiontexurevertex6;
        field_1401_j[7] = positiontexurevertex7;
        field_1400_k[0] = new TexturedQuad(new PositionTexureVertex[] {
        ...
        field_1400_k[1] = new TexturedQuad(new PositionTexureVertex[] {
        ...
        field_1400_k[2] = new TexturedQuad(new PositionTexureVertex[] {
        ...
        field_1400_k[3] = new TexturedQuad(new PositionTexureVertex[] {
        ...
        field_1400_k[4] = new TexturedQuad(new PositionTexureVertex[] {
        ...
        field_1400_k[5] = new TexturedQuad(new PositionTexureVertex[] {
    ...
    private void func_924_c(float f)
    {
        ...
        {
            field_1400_k[i].func_808_a(tessellator, f);
        }
