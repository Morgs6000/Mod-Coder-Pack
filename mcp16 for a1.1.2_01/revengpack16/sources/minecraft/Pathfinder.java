...
public class Pathfinder
{
    ...
    {
        return func_1130_a(entity, entity1.posX, entity1.boundingBox.field_1697_b, entity1.posZ, f);
    }
            ...
            float f)
    {
        ...
        PathPoint pathpoint = func_1136_a(MathHelper.func_1108_b(entity.boundingBox.field_1698_a), MathHelper.func_1108_b(entity.boundingBox.field_1697_b), MathHelper.func_1108_b(entity.boundingBox.field_1704_c));
    ...
    private int func_1133_b(Entity entity, PathPoint pathpoint, PathPoint pathpoint1, PathPoint pathpoint2, float f)
    {
        int i = 0;
        int j = 0;
        if(func_1132_a(entity, pathpoint.field_1718_a, pathpoint.field_1717_b + 1, pathpoint.field_1716_c, pathpoint1) > 0)
        {
            j = 1;
        }
    ...
    private PathPoint func_1135_a(Entity entity, int i, int j, int k, PathPoint pathpoint, int l)
    {
        ...
        if(func_1132_a(entity, i, j, k, pathpoint) > 0)
        {
            pathpoint1 = func_1136_a(i, j, k);
        }
        if(pathpoint1 == null && func_1132_a(entity, i, j + l, k, pathpoint) > 0)
        {
        ...
        {
            int i1 = 0;
            for(int j1 = 0; j > 0 && (j1 = func_1132_a(entity, i, j - 1, k, pathpoint)) > 0; j--)
            {
                if(j1 < 0)
                {
                    return null;
    ...
    private int func_1132_a(Entity entity, int i, int j, int k, PathPoint pathpoint)
    {
        for(int l = i; l < i + pathpoint.field_1718_a; l++)
        {
            for(int i1 = j; i1 < j + pathpoint.field_1717_b; i1++)
            {
                ...
                {
                    Material material = field_1674_a.func_599_f(i, j, k);
    ...
    private MCHashTable field_1676_c;
