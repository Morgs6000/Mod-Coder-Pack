        ...
        for(int i1 = field_1298_b; i1 <= field_1302_e; i1++)
        {
            for(int j1 = field_1303_d; j1 <= field_1300_g; j1++)
            {
                ...
                for(int k1 = field_1304_c; k1 <= field_1301_f; k1++)
                {
                    ...
                    int l1 = world.func_641_a(field_1299_a, i1, k1, j1);
                    int i2 = 0;
                    int j2 = world.func_600_a(i1, k1, j1);
                    int k2 = Block.field_341_r[j2];
                    if(k2 == 0)
                    {
                        k2 = 1;
                    }
                    ...
                    {
                        int i3 = world.func_641_a(field_1299_a, i1 - 1, k1, j1);
                        int k3 = world.func_641_a(field_1299_a, i1 + 1, k1, j1);
                        int l3 = world.func_641_a(field_1299_a, i1, k1 - 1, j1);
                        int i4 = world.func_641_a(field_1299_a, i1, k1 + 1, j1);
                        int j4 = world.func_641_a(field_1299_a, i1, k1, j1 - 1);
                        int k4 = world.func_641_a(field_1299_a, i1, k1, j1 + 1);
                        i2 = i3;
                        if(k3 > i2)
                        {
                            i2 = k3;
                    ...
                    world.func_664_b(field_1299_a, i1, k1, j1, i2);
                    int j3 = i2 - 1;
                    if(j3 < 0)
                    {
                        j3 = 0;
                    }
                    world.func_631_a(field_1299_a, i1 - 1, k1, j1, j3);
                    world.func_631_a(field_1299_a, i1, k1 - 1, j1, j3);
                    world.func_631_a(field_1299_a, i1, k1, j1 - 1, j3);
